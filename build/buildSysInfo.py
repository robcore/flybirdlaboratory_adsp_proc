...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/dspbuild.adsp/2.5/buildSysInfo.py#6 $
...
#    global default_buildid; default_buildid = 0
    ...
    def __init__(self):
        ...
        self.mpd_flag = 0
        self.clean_flag = 0
        self.klocwork_flag = 0
        self.cosim_flag = 0
        self.cosim_run_flag = 0
        self.oemroot_cosim_run_flag = 0
        self.sim_flag = 0
        self.sim_check = 0
        self.pkg_all_flag = 0
