...
#define RHEAP_HIGH_HEAP_THRESHOLD  (RHEAP_GROWTH_SIZE - 2*1024)
#endif // RHEAP_HIGH_HEAP_THRESHOLD

#ifndef CAP_HLOS_HEAP
#define CAP_HLOS_HEAP           3 * 1024 * 1024
#endif // CAP_HLOS_HEAP
