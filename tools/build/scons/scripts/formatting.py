...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/scons.qc/1.1/scripts/formatting.py#7 $
...
def generate(env):
    ...
    if verbose == 3:
        ...
        env.Replace(ASPPCOMSTR="=== Assembling $SOURCE.name ==> $TARGET")
        ...
        env.Replace(CXXPPCLCOM_ASTR= \
            "=== Cleaning   ${TARGET.name}.pp ==> ${TARGET}.i")
        env.Replace(SHCCCOMSTR="=== Compiling  $SOURCE.name ==> $TARGET")
        env.Replace(SHCCPPCOMSTR="=== Preprocess $SOURCE.name ==> $TARGET")
        env.Replace(SHCCPPCOM_ASTR= \
            "=== Preprocess $SOURCE.name ==> ${TARGET}.pp")
        env.Replace(SHCCMIXCOMSTR="=== Generate   $SOURCE.name ==> $TARGET")
        env.Replace(SHCCMIXCOM_ASTR= \
            "=== Generate   $SOURCE.name ==> ${TARGET}.mix")
        env.Replace(SHCCPPCLCOMSTR="=== Cleaning   $SOURCE.name ==> $TARGET")
        env.Replace(SHCCPPCLCOM_ASTR= \
            "=== Cleaning   ${TARGET.name}.pp ==> ${TARGET}.i")
        env.Replace(SHHDEPTREECOMSTR= \
            "=== Generate   ${TARGET.name}.pp ==> ${TARGET}.dep")
        env.Replace(SHCXXCOMSTR="=== Compiling  $SOURCE.name ==> $TARGET")
        env.Replace(SHCXXPPCOMSTR="=== Preprocess $SOURCE.name ==> $TARGET")
        env.Replace(SHCXXPPCOM_ASTR= \
            "=== Preprocess $SOURCE.name ==> ${TARGET}.pp")
        env.Replace(SHCXXMIXCOMSTR= \
            "=== Generate   $SOURCE.name ==> ${TARGET}.mix")
        env.Replace(SHCXXPPCLCOMSTR="=== Cleaning   $SOURCE.name ==> $TARGET")
        ...
        if 0 and env.has_key('PLATFORM') and env['PLATFORM'] == 'cygwin':
            ...
            env.Replace(CCCOMSTR= \
                "=== Compiling  $SOURCE.name ==> $TARGET.posix")
            env.Replace(CCPPCOMSTR= \
                "=== Preprocess $SOURCE.name ==> $TARGET.posix")
            env.Replace(CCPPCOM_ASTR= \
                "=== Preprocess $SOURCE.name ==> ${TARGET.posix}.pp")
            env.Replace(CCMIXCOMSTR= \
                "=== Generate   $SOURCE.name ==> $TARGET.posix")
            env.Replace(CCMIXCOM_ASTR= \
                "=== Generate   $SOURCE.name ==> ${TARGET.posix}.mix")
            env.Replace(CCPPCLCOMSTR= \
                "=== Cleaning   $SOURCE.name ==> $TARGET.posix")
            env.Replace(CCPPCLCOM_ASTR= \
            ...
            env.Replace(ASCOMSTR= \
                "=== Assembling $SOURCE.name ==> $TARGET.posix")
