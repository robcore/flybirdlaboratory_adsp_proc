...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.adsp/2.6.1/wls/src/wlan_location_service_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const uint8_t wls_disc_scan_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wls_disc_scan_req_msg_v01, use_cached) - QMI_IDL_OFFSET16RELATIVE(wls_disc_scan_req_msg_v01, use_cached_valid)),
  0x11,
...
static const uint8_t wls_sub_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wls_sub_req_msg_v01, snoop_mode) - QMI_IDL_OFFSET8(wls_sub_req_msg_v01, snoop_mode_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
...
static const uint8_t wls_event_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wls_event_ind_msg_v01, ap_info) - QMI_IDL_OFFSET8(wls_event_ind_msg_v01, ap_info_valid)),
  0x18,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(wls_event_ind_msg_v01, ap_info),
  QMI_IDL_TYPE88(0, 2),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wls_event_ind_msg_v01, supported_scan_freq_list) - QMI_IDL_OFFSET8(wls_event_ind_msg_v01, supported_scan_freq_list_valid)),
  0x19,
   QMI_IDL_AGGREGATE,
...
static const uint8_t wls_scan_result_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wls_scan_result_ind_msg_v01, ap_array) - QMI_IDL_OFFSET8(wls_scan_result_ind_msg_v01, ap_array_valid)),
  0x12,
...
static const qmi_idl_service_message_table_entry wls_service_command_messages_v01[] = {
  ...
  {QMI_WLS_STS_QUERY_REQ_V01, QMI_IDL_TYPE16(0, 2), 7},
  {QMI_WLS_SCAN_REQ_V01, QMI_IDL_TYPE16(0, 4), 896},
  {QMI_WLS_SUB_REQ_V01, QMI_IDL_TYPE16(0, 6), 36}
};
...
static const qmi_idl_service_message_table_entry wls_service_indication_messages_v01[] = {
  {QMI_WLS_STS_IND_V01, QMI_IDL_TYPE16(0, 8), 170},
  {QMI_WLS_EVENT_IND_V01, QMI_IDL_TYPE16(0, 8), 170},
  {QMI_WLS_SCAN_RESULT_IND_V01, QMI_IDL_TYPE16(0, 9), 2075},
