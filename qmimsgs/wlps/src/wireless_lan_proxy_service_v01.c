...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.adsp/2.6.1/wlps/src/wireless_lan_proxy_service_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.14.2 
   It was generated on: Sat Dec 13 2014 (Spin 1)
...
static const qmi_idl_service_message_table_entry wlps_service_command_messages_v01[] = {
  ...
  {QMI_WLPS_UPDATE_CLIENT_STATUS_REQ_V01, QMI_IDL_TYPE16(0, 2), 198}
};
