...
/*=============================================================================
Edit History
$Header: //components/rel/core.adsp/2.6.1/debugtools/rcinit/src/rcinit_rex_term.c#1 $
...
void rcinit_internal_unprocess_groups(void)
{
   ...
   do
   {
      ...
      rcevt_register_sigex_name(RCINIT_RCEVT_TERMACK, RCEVT_SIGEX_TYPE_SIGREX, &rcevt_sigex);
      ...
      rcevt_unregister_sigex_name(RCINIT_RCEVT_TERMACK, RCEVT_SIGEX_TYPE_SIGREX, &rcevt_sigex);
