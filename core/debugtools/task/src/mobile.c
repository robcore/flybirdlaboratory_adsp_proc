...
/*===========================================================================
  ...
  $Header: //components/rel/core.adsp/2.6.1/debugtools/task/src/mobile.c#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/11/15   qctecmdr Version ADSP.BF.2.6-00508-M8994AAAAAAAZL-1 Support for 8994.LA.1.0
...
NOTICE_TYPE rel_date[] = "Jun 11 2015";
NOTICE_TYPE rel_time[] = "13:00:00";
...
NOTICE_TYPE mob_sw_rev[] = "ADSP.BF.2.6-00508-M8994AAAAAAAZL-1";
