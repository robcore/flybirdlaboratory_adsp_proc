...
$Header: //components/rel/core.adsp/2.6.1/mproc/smem/honeybadger/smem_hwio.h#1 $
...
/* Honeybadger family values */
#define TCSR_TCSR_REGS_REG_BASE           (CORE_TOP_CSR_BASE_TARG_INFO_ADDR + \
                                            0x000A0000)
#define TCSR_TCSR_REGS_REG_BASE_PHYS      (CORE_TOP_CSR_BASE_PHYS + 0x000A0000)
