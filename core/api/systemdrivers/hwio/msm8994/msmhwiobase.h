...
/*
  ...
  $Header: //components/rel/core.adsp/2.6.1/api/systemdrivers/hwio/msm8994/msmhwiobase.h#1 $
...
/*----------------------------------------------------------------------------
 * BASE: QDSS_QDSS_TOTAL
 *--------------------------------------------------------------------------*/

#define QDSS_QDSS_TOTAL_BASE                                        0xe2100000
#define QDSS_QDSS_TOTAL_BASE_SIZE                                   0x00080000
#define QDSS_QDSS_TOTAL_BASE_PHYS                                   0xfc300000
