...
$Header: //components/rel/core.adsp/2.6.1/api/power/npa.h#1 $
============================================================================*/
#ifndef NPA_H
#define NPA_H
...
{ /* Default request behavior */
  ...
  /* Attributes that are public i.e. set by user code must be below
     this value */
  NPA_MAX_PUBLIC_REQUEST_ATTR = 0x00000010,

  NPA_REQUEST_RESERVED_ATTR1  = 0x80000000,
