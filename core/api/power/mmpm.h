...
$Header: //components/rel/core.adsp/2.6.1/api/power/mmpm.h#1 $
...
/** @endcond */
    ...
    MMPM_CORE_ID_LPASS_AVSYNC= 107,   /**< Audio-video timer/ProntoSync hardware
                                           in the LPASS. */
    ...
    MMPM_CORE_ID_LPASS_BSTC = 114,    /**< Broadcast System Time Clock (STC) in
                                           the LPASS. */
...
typedef struct {
    ...
    /**< ID of the information type.
         ...
         - #MMPM_INFO_ID_CORE_CLK_MAX
         - #MMPM_INFO_ID_MIPS_MAX
         - #MMPM_INFO_ID_BW_MAX @tablebulletend */
