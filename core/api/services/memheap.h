...
===========================================================================*/
/*
Copyright (c) 1997-2015 Qualcomm Technologies Incorporated.
All rights reserved.
...
$Header: //components/rel/core.adsp/2.6.1/api/services/memheap.h#2 $ $DateTime: 2015/04/13 13:35:05 $ $Author: pwbldsvc $
