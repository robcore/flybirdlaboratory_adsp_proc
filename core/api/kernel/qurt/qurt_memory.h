...
/**@ingroup func_qurt_mem_l2cache_line_lock 
  Performs a L2 cache line locking operation. This function locks selectively lines in the L2 cache memory.
  @note1hang The line lock operation can be performed only on the 32 bytes aligned size and address.

  @datatypes
  #qurt_addr_t \n
  #qurt_size_t \n
 
  @param[in] addr      Address of l2 cache memory line to be locked. Address has to be 32 byte alignment
  @param[in]  size     Size (in bytes) of l2 cache memory to be line locked.Size has to be multiple of 32 bytes
...
/**@ingroup funcqurt_mem_l2cache_line_unlock 
  Performs a L2 cache line unlocking operation. This function unlocks selectively lines in the L2 cache memory.
  @note1hang The line unlock operation can be performed only on the 32 bytes aligned size and address.
  ...
  @param[in] addr      Address of l2 cache memory line to be locked. Address has to be 32 byte alignment.
  @param[in]  size     Size (in bytes) of l2 cache memory to be line ulocked.Size has to be multiple of 32 bytes.
 
  @return
  QURT_EOK -- Cache operation performed successfully.\n
  QURT_EALIGN -- Aligning data or address failed.\n
  QURT_EFAILED -- Operation failed, Can not find the matching tag
