...
/**
   Sets the cache partition for the calling thread.
  
   @param   Use the type of qurt_cache_partition_t to select cache partition 
            of the calling thread for l1_icache, l1_dcache, l2_cache.
...
/**
   Sets coprocessor configuration.
  
   @param[in]  enable         Enable with non-zero value, and disable with zero value
   @param[in]  coproc_id      Set to a number of valid coprocessor identifier
