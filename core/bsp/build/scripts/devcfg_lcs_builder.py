...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.adsp/2.6.1/bsp/build/scripts/devcfg_lcs_builder.py#1 $
...
# --------   ---     ----------------------------------------------------------
# 09/12/14   aa      Removing intermediate linker variable for base address in 
#                    deviceconfig image, not required and not supported on llvm.
