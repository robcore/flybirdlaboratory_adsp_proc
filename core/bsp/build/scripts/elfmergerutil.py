...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.adsp/2.6.1/bsp/build/scripts/elfmergerutil.py#1 $
...
# --------   ---     ---------------------------------------------------------
# 10/01/14   aa      Removed Qshrink support, moved to devcfg_img.scons
# 10/01/14   aa      Created History
#
#===============================================================================
