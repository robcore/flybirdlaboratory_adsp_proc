...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.adsp/2.6.1/bsp/build/scripts/devcfg_builder.py#1 $
...
def devcfg_xml_builder(target, source, env):
    ...
    master_xml = devcfg_create_master_xml_file(rootenv, target_xml_full , target_env_full , env['CONFIG'], env)
    
    return
    
    
def devcfg_create_master_xml_file(env, filepathname, env_filepathname, env_config_list, dalenv):
    """
