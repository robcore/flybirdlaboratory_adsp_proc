...
$Header: //components/rel/core.adsp/2.6.1/services/utimers/src/utimer_client.c#1 $ 
...
)
{
   ...
   return utimer_invoke_set_64(utimer_client_qdi_handle, timer, time, reload, unit);
}
