...
Copyright (c) 1997-2014 by Qualcomm Technologies Incorporated.  All Rights Reserved.
============================================================================ */
...
$Header: //components/rel/core.adsp/2.6.1/services/umemheap/src/umemheap_lite.c#1 $ $DateTime: 2014/10/16 12:45:40 $ $Author: pwbldsvc $
