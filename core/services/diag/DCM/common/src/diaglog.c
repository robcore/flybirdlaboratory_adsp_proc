...
Copyright (c) 1990-2014 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.adsp/2.6.1/services/diag/DCM/common/src/diaglog.c#1 $
