...
/*===========================================================================
 ...
 $Header: //components/rel/core.adsp/2.6.1/services/diag/DCM/common/src/diagcomm_io.h#1 $
...
{
  DIAGCOMM_PORT_1 = 0,  
 // DIAGCOMM_PORT_2 = 1,  /*Stream 2 is not supported on ADSP */
...
typedef union
{
  ...
  struct
  {
    ...
    dsm_watermark_type       *cmd_tx_queue;      /* Watermark queue to hold cmd rsp on data channel
                                                    without cmd channel seperation feature */
