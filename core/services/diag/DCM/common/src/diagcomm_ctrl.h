...
/*===========================================================================
 ...
 $Header: //components/rel/core.adsp/2.6.1/services/diag/DCM/common/src/diagcomm_ctrl.h#1 $
...
uint32 diagcomm_ctrl_send_mult_pkt( void * ctrl_pkt, uint32 ctrl_pktlen, 
                                    const void * user_pkt, uint32 user_pktlen,
