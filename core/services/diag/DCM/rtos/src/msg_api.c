...
$Header: //components/rel/core.adsp/2.6.1/services/diag/DCM/rtos/src/msg_api.c#1 $
...
void *diag_stm_qsr_msg_prep(const const msg_qsr_const_type * const_blk, unsigned int num_args, uint32 isHash, uint32 *len)
{
  uint32 msg_size = 0;
  void * msg;
