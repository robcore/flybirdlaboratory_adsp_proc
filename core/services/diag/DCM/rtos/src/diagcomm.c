...
/*===========================================================================
 ...
 $Header: //components/rel/core.adsp/2.6.1/services/diag/DCM/rtos/src/diagcomm.c#1 $ $DateTime: 2014/10/16 12:45:40 $ $Author: pwbldsvc $
...
============================================================================*/
void *
diagpkt_to_data_mode ( void * req_pkt, uint16 pkt_len)
{
...
============================================================================*/
void *
diagcomm_config_comm ( void * req_pkt, word pkt_len)
{
#ifdef DIAG_SIO_SUPPORT
...
============================================================================*/
void *
diagcomm_mode_chg_pkt (void * req_pkt, uint16 pkt_len)
{
