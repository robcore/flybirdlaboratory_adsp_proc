...
Copyright (c) 1991-2014 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
      ...
      $Header: //components/rel/core.adsp/2.6.1/services/diag/LSM/common/src/diag_v.h#1 $
...
/* Proc ID definitions */
 ...
 #undef DIAG_MY_PROC_ID
 #undef DIAGDIAG_TX_MODE_CONFIG
 #undef DIAGDIAG_STRESS_TEST_DELAYED_RSP
