...
/*===========================================================================
      ...
      $Header: //components/rel/core.adsp/2.6.1/services/diag/LSM/qurt/src/Diag_LSM_stm.h#1 $
...
#define diag_stm_log_alloc(x) diag_stm_alloc(x) 
#define diag_stm_msg_free(x) diag_stm_free(x)
#define diag_stm_event_free(x) diag_stm_free(x)
#define diag_stm_log_free(x) diag_stm_free(x)
