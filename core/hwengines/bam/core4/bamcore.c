...
===============================================================================
 ...
 $Header: //components/rel/core.adsp/2.6.1/hwengines/bam/core4/bamcore.c#1 $
...
#define BAM_MAX_VERSION 0xA // Elassar

#define BAMLITE_MIN_VERSION 0x13 // Aragorn
#define BAMLITE_MAX_VERSION 0x17 // Elassar

#define BAMNDP_MIN_VERSION 0x20 // Aragorn
#define BAMNDP_MAX_VERSION 0x24 // Elassr
