...
--------   ---     ------------------------------------------------------------
12/06/12   RL      branched from 8974
...
#define CRYPTO1_TOP_BASE              0xFD440000
#define CRYPTO2_TOP_BASE              0XFD4C0000
#define USB3_WRAPPER_BASE             0xF9200000
#define QDSS_TRACE_BASE               0xFC300000
#define LPASS_TOP_BASE                0xFE000000
#define BCSS_TOP                      0xFC600000

/* Bam Module base address info */
#define BAM_NDP_CRYPTO0_BASE         (CRYPTO0_TOP_BASE + 0x00004000)
#define BAM_NDP_CRYPTO1_BASE         (CRYPTO1_TOP_BASE + 0x00004000)
#define BAM_NDP_CRYPTO2_BASE         (CRYPTO2_TOP_BASE + 0x00004000)
#define BAM_NDP_CRYPTO0_XPU2_BASE    (CRYPTO0_TOP_BASE + 0x00002000)
#define BAM_NDP_CRYPTO0_VMIDMT_BASE  (CRYPTO0_TOP_BASE + 0x00000000)
