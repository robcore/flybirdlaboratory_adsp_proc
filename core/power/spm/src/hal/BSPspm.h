...
$Header: //components/rel/core.adsp/2.6.1/power/spm/src/hal/BSPspm.h#1 $
 ...
 * registers.
 */
extern BSP_spm_ConfigDataType *g_spmBspData;
 ...
 */
extern BSP_spm_CmdSequenceType (*g_spmCmdSeqArray)[SPM_NUM_LOW_POWER_MODES];
 ...
 *
 * @Dependencies:
 *   g_spmNumCores must be initialized.
 *   g_spmCmdSeqArray must be a valid pointer.
 * 
