...
================================================================================
$Header: //components/rel/core.adsp/2.6.1/power/sleep/src/npa_nodes/node_definition_l2_cache.c#1 $
                                                 ...
                                                 npa_resource_state state )
{
  ...
  if ( state )
  {
    /* Someone is requesting L2 to be on i.e. power collapse with l2 retention
     * mode. */
