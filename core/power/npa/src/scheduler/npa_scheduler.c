...
$Header: //components/rel/core.adsp/2.6.1/power/npa/src/scheduler/npa_scheduler.c#1 $
============================================================================*/
                                               ...
                                               unsigned int data_size )
{
  ...
  resource->_internal->active_attr = \
...
{ 
  ...
  /* save the pending request because we are about to issue another
                                       ...
                                       npa_duration *dur_ptr )
{
  ...
  ULOG_RT_PRINTF_5( npa_scheduler.log,
                    "npa_run_scheduled_request (handle: 0x%08x) "
