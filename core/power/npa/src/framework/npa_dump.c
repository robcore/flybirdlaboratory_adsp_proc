...
$Header: //components/rel/core.adsp/2.6.1/power/npa/src/framework/npa_dump.c#1 $
============================================================================*/
...
static void npa_dump_resource_state( ULogHandle log, npa_resource *resource )
{
  ...
  driver_stats = resource->_internal->driver_duration;
