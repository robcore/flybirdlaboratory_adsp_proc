...
$Header: //components/rel/core.adsp/2.6.1/power/npa/src/framework/npa_client.c#1 $
============================================================================*/
                                           ...
                                           int  new_request ) )
{
  ...
  if ( npa_resource_has_attribute( resource, NPA_RESOURCE_SINGLE_CLIENT ) )
  {
...

{
  ...
  if ( client )
  {
    ULOG_RT_PRINTF_4( npa.log,
                      "\tend npa_create_sync_client (handle: 0x%08x) "
                      "(resource: \"%s\") "
                      "(client: \"%s\") (client_type: %s)",
                      client, 
...

{
  ...
  {    
    ...
    ULOG_RT_PRINTF_4( npa.log,
                      "\tend npa_create_async_client (handle: 0x%08x) "
                      "(resource: \"%s\") "
                      "(client: \"%s\") (client_type: %s) ",
                      client, 
                      client->resource_name,
                               ...
                               npa_resource_state  state )
{
  ...
  ULOG_RT_PRINTF_6( client->log_handle,
                    "npa_issue_%s_request (handle: 0x%08x) (client: \"%s\") "
                    "(request: %u) "
                                  ...
                                  npa_resource_state_delta  delta )
{
  ...
  ULOG_RT_PRINTF_5( client->log_handle,
                    "npa_modify_request (handle: 0x%08x) (client: \"%s\") "
                    "(delta: %d) "
                    "(resource: \"%s\") (attr: 0x%08x)",
                    client, client->name, 
                    delta, 
                               ...
                               npa_resource_state *vector )
{
  ...
  CORE_VERIFY_PTR( client->type & NPA_CLIENT_VECTOR );
  ...
  if ( npa_vector_logging_limit != 0 )
  {
    ...
    ULOG_RT_PRINTF_6( client->log_handle,
                      "npa_issue_%s_vector_request "
                      "(handle: 0x%08x) (client: \"%s\") "
                      "(resource: \"%s\") (attr: 0x%08x) "
                      "(num_elems: %d) (vector: %m)",
                      client_type, client, client->name, 
                      client->resource_name, client->request_attr,
                      num_elems );
...
void npa_complete_request( npa_client_handle client )
{
  ...
  ULOG_RT_PRINTF_4( client->log_handle,
                    "npa_complete_request (handle: 0x%08x) (client: \"%s\") "
                    "(resource: \"%s\") "
                    "(attr: 0x%08x)",
                    client, client->name, 
                    client->resource_name,
...
void npa_cancel_request( npa_client_handle client )
{
  ...
  ULOG_RT_PRINTF_4( client->log_handle,
                    "npa_cancel_request (handle: 0x%08x) (client: \"%s\") "
                    "(resource: \"%s\") "
                    "(attr: 0x%08x)",
                    client, client->name, 
                    client->resource_name,
...
void npa_destroy_client( npa_client_handle client )
{
  ...
  ULOG_RT_PRINTF_3( npa.log,
                    "npa_destroy_client (handle: 0x%08x) (client: \"%s\") "
                    "(resource: \"%s\")",
                    client, client_name,
                    resource_name );
                                    ...
                                    npa_client_type   new_type )
{
  ...
  CORE_VERIFY( 
    npa_resource_has_attribute( resource, 
  ...
  NPA_PENDING_REQUEST(client) = NPA_ACTIVE_REQUEST(client);
  client->issue_request( client, 1 );
}
