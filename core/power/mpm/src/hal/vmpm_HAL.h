...
===============================================================================
$Header: //components/rel/core.adsp/2.6.1/power/mpm/src/hal/vmpm_HAL.h#1 $
 ...
 * @return None
 */
void vmpm_HAL_All_Clear( void ) UMPM_CODE_SECTION;
 ...
 * @return None
 */
void vmpm_HAL_GetNumberMasks( uint32 *pnNumber ) UMPM_CODE_SECTION;
 ...
 * @see vmpm_HAL_GetNumberMasks
 */
void vmpm_HAL_GetPending( uint32 nMaskIndex, uint32 *pnMask ) UMPM_CODE_SECTION;
