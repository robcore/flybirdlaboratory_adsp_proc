...
===============================================================================
$Header: //components/rel/core.adsp/2.6.1/power/mpm/src/os/default/vmpm_target.c#1 $
...
mpm_int_pin_mapping_type vmpm_pinMapTbl[MPM_MAX_NUM_INTS] UMPM_DATA_SECTION;
