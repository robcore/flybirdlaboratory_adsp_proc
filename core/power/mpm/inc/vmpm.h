...
===============================================================================
$Header: //components/rel/core.adsp/2.6.1/power/mpm/inc/vmpm.h#1 $
 ...
 * as a UMPM section are public. */
#define UMPM_CODE_SECTION __attribute__((section (UMPM_ISLAND_CODE_STR)))
#define UMPM_DATA_SECTION __attribute__((section (UMPM_ISLAND_DATA_STR)))

#else
/* Define empty macros */
#define UMPM_CODE_SECTION 
#define UMPM_DATA_SECTION 

#endif /* UMPM_ISLAND_MODE_ENABLE */
