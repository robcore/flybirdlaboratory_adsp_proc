...
================================================================================
$Header: //components/rel/core.adsp/2.6.1/power/sleep2.0/src/synthesizer/synthTypes.h#1 $
...
struct sleep_synth_lprm_s
{
  ...
  /* Used to determine whether synth mode is cacheable or uncacheable 
   * A Synth mode is cacheable only if all component modes are cacheable */
