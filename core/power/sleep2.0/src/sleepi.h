...
================================================================================
$Header: //components/rel/core.adsp/2.6.1/power/sleep2.0/src/sleepi.h#1 $
 ...
 *
* @param firstNondeferrable: Pointer that will be populated with the first
 *                            non-deferrable timer.
 *                            This parameter can be NULL if the caller does not care
 *                            about this specific deadline.
 *
