...
================================================================================
$Header: //components/rel/core.adsp/2.6.1/power/sleep2.0/src/lpr/q6_lpm_config_v60.c#1 $
...
void q6LPMConfig_setupBase(void)
{
  ...
  HWIO_OUT( LPASS_QDSP6SS_SPMCTL_EN_CLAMP, 0x3 );
  HWIO_OUT( LPASS_QDSP6SS_SPMCTL_EN_CLK, 0x3FF );
  HWIO_OUT( LPASS_QDSP6SS_SPMCTL_EN_BHS, 0x3 ); 
  ...
  HWIO_OUTF( LPASS_QDSP6SS_WAKEUP_CTL, L2VIC_WAKE_EN, 1 );
  ...
  HWIO_OUT( LPASS_QDSP6SS_SPMCTL_EN_PLL, 
            HWIO_FVAL( LPASS_QDSP6SS_SPMCTL_EN_PLL, PLL_FREEZE, 0x0 ) |
                                  ...
                                  boolean triggerPMI )
{
  ...
  HWIO_OUT( LPASS_QDSP6SS_SLPC_CFG, 
            HWIO_FVAL( LPASS_QDSP6SS_SLPC_CFG, EXTHW_WAKE_EN,       0x0             ) |
            HWIO_FVAL( LPASS_QDSP6SS_SLPC_CFG, MEM_PU_PERI_STAGGER, 0x1             ) |
            HWIO_FVAL( LPASS_QDSP6SS_SLPC_CFG, MEM_PD_PERI_STAGGER, 0x0             ) |
            HWIO_FVAL( LPASS_QDSP6SS_SLPC_CFG, MEM_PU_ARRY_STAGGER, 0x1             ) |
            HWIO_FVAL( LPASS_QDSP6SS_SLPC_CFG, MEM_PD_ARRY_STAGGER, 0x0             ) |
...
void q6LPMConfig_setupL2NonRetConfig(void)
{
  ...
  const uint32 regNonRetSPMCtlEnMem = 
    ( HWIO_FVAL(LPASS_QDSP6SS_SPMCTL_EN_MEM, CLAMP_QMC_MEM, 0x1 ) |
      ...
      HWIO_FVAL(LPASS_QDSP6SS_SPMCTL_EN_MEM, L1IU,          0x3 ) |
      HWIO_FVAL(LPASS_QDSP6SS_SPMCTL_EN_MEM, L1DU,          0x3 ) |
      HWIO_FVAL(LPASS_QDSP6SS_SPMCTL_EN_MEM, L2PLRU,        0x1 ) |
      HWIO_FVAL(LPASS_QDSP6SS_SPMCTL_EN_MEM, L2TAG,         0xF ) |
...
void q6LPMConfig_setupL2RetConfig(void)
{
  ...
  const uint32 regRetSPMCtlEnMem = 
    ( HWIO_FVAL(LPASS_QDSP6SS_SPMCTL_EN_MEM, CLAMP_QMC_MEM,  0x1) |
      HWIO_FVAL(LPASS_QDSP6SS_SPMCTL_EN_MEM, CLAMP_WL,       0x1) |
      HWIO_FVAL(LPASS_QDSP6SS_SPMCTL_EN_MEM, MEM_PERIPH,     0x1) |
      HWIO_FVAL(LPASS_QDSP6SS_SPMCTL_EN_MEM, L2DATA_STBY,    0x0) |
  ...
  HWIO_OUT(LPASS_QDSP6SS_SPMCTL_EN_MEM, regRetSPMCtlEnMem);
}
