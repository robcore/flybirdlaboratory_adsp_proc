...
$Header: //components/rel/core.adsp/2.6.1/power/ulog/src/ULogInlines.h#1 $
============================================================================*/
 ...
 * Inline function to Lock a ULog Tee to prevent out
 * of order logs.
 */
 ...
 * Inline function to Release a ULog Tee to prevent out
 * of order logs.
 */
