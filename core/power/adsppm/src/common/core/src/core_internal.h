 ...
 */
typedef struct{
    uint32            numOfRegisteredClients; //number of active clients
    uint64            clientIdNumMask;
    uint32            clientIdNum; //clientNum used to assign clientId
...
/**
 * @fn findAdsppmHandle - find the client handle in linked list
 */
