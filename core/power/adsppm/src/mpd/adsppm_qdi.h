...
/* the follow definition for testing code*/
#define ADSPPM_CHECKCOREID (QDI_PRIVATE+16)
#define ADSPPM_CHECKMEMID  (QDI_PRIVATE+17)
#define ADSPPM_CHECKCLKID  (QDI_PRIVATE+18)
#define ADSPPM_CHECKBUSPORT  (QDI_PRIVATE+19)
