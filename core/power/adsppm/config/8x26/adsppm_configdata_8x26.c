...
/**
 * Array of 8x26 Core Clocks per core. Arranged by to core ID
 */
const AdsppmClkIdType coreClocks_SlimBus_8x26[] = {AdsppmClk_Slimbus_Core};
//const AdsppmClkIdType coreClocks_Midi_8x26[]    = {AdsppmClk_Midi_Core};
//const AdsppmClkIdType coreClocks_HwRsp_8x26[]   = {AdsppmClk_HwRsp_Core};

/**
 * Array of 8x26 Master Bus Ports per core. Arranged by to core ID
 */
const AdsppmBusPortIdType masterPorts_ADSP_8x26[]    = {AdsppmBusPort_Adsp_Master};
const AdsppmBusPortIdType masterPorts_DML_8x26[]     = {AdsppmBusPort_Dml_Master};
const AdsppmBusPortIdType masterPorts_AIF_8x26[]     = {AdsppmBusPort_Aif_Master};
const AdsppmBusPortIdType masterPorts_SlimBus_8x26[] = {AdsppmBusPort_Slimbus_Master};
//const AdsppmBusPortIdType masterPorts_Midi_8x26[]    = {AdsppmBusPort_Midi_Master};
//const AdsppmBusPortIdType masterPorts_HWRSMP_8x26[]  = {AdsppmBusPort_HwRsmp_Master};
//const AdsppmBusPortIdType masterPorts_Spdif_8x26[]   = {AdsppmBusPort_Spdif_Master};
//const AdsppmBusPortIdType masterPorts_Hdmirx_8x26[]  = {AdsppmBusPort_Hdmirx_Master};
//const AdsppmBusPortIdType masterPorts_Sif_8x26[]     = {AdsppmBusPort_Sif_Master};

/**
 * Array of 8x26 Slave Bus Ports per core. Arranged by to core ID
 */
const AdsppmBusPortIdType slavePorts_ADSP_8x26[]    = {AdsppmBusPort_Adsp_Slave};
const AdsppmBusPortIdType slavePorts_LPM_8x26[]     = {AdsppmBusPort_Lpm_Slave};
const AdsppmBusPortIdType slavePorts_DML_8x26[]     = {AdsppmBusPort_Dml_Slave};
const AdsppmBusPortIdType slavePorts_AIF_8x26[]     = {AdsppmBusPort_Aif_Slave};
const AdsppmBusPortIdType slavePorts_SlimBus_8x26[] = {AdsppmBusPort_Slimbus_Slave};
//const AdsppmBusPortIdType slavePorts_Midi_8x26[]    = {AdsppmBusPort_Midi_Slave};
const AdsppmBusPortIdType slavePorts_AVsync_8x26[]  = {AdsppmBusPort_AvSync_Slave};
//const AdsppmBusPortIdType slavePorts_HWRSMP_8x26[]  = {AdsppmBusPort_HwRsmp_Slave};
const AdsppmBusPortIdType slavePorts_SRam_8x26[]    = {AdsppmBusPort_Sram_Slave};
//const AdsppmBusPortIdType slavePorts_DCodec_8x26[]  = {AdsppmBusPort_Dcodec_Slave};
//const AdsppmBusPortIdType slavePorts_Spdif_8x26[]   = {AdsppmBusPort_Spdif_Slave};
//const AdsppmBusPortIdType slavePorts_Hdmirx_8x26[]  = {AdsppmBusPort_Hdmirx_Slave};
//const AdsppmBusPortIdType slavePorts_Sif_8x26[]     = {AdsppmBusPort_Sif_Slave};
//const AdsppmBusPortIdType slavePorts_BSTC_8x26[]    = {AdsppmBusPort_Bstc_Slave};

/**
 * Array of 8x26 core descriptors. Arranged according to core ID enum
 */
const AsicCoreDescType cores_array_8x26[] =
{
        {   //Adsppm_Core_Id_None
        ...
        {   //Adsppm_Core_Id_ADSP
                ...
                {0, NULL}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_ADSP_8x26)}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_ADSP_8x26)}, //Slave port instances
        ...
        {   //Adsppm_Core_Id_LPM
                ...
                {0, NULL}, //Core clock instances
                {0, NULL}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_LPM_8x26)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_DML
                ...
                AsicPowerDomain_LpassCore, //Power Domain
                {0, NULL}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_DML_8x26)}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_DML_8x26)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_AIF
                ...
                AsicPowerDomain_LpassCore, //Power Domain
                {0, NULL}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_AIF_8x26)}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_AIF_8x26)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_SlimBus
                ...
                AsicPowerDomain_LpassCore, //Power Domain
                {ADSPPM_ARRAY(coreClocks_SlimBus_8x26)}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_SlimBus_8x26)}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_SlimBus_8x26)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_Midi
                Adsppm_Core_Id_None, //Core ID
        ...
        {   //Adsppm_Core_Id_AVsync
                ...
                {0, NULL}, //Core clock instances
                {0, NULL}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_AVsync_8x26)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        ...
        {   //Adsppm_Core_Id_SRam
                ...
                {0, NULL}, //Core clock instances
                {0, NULL}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_SRam_8x26)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
...
AsicCoreDescriptorArrayType cores_8x26 = {ADSPPM_ARRAY(cores_array_8x26)};

const AsicMemDescriptorType memories_array_8x26[] =
{
        {   //Adsppm_Mem_None
...
AsicMemDescriptorArrayType memories_8x26 = {ADSPPM_ARRAY(memories_array_8x26)};

/**
 * Array of 8x26 core clock descriptors. Arranged by core clock ID
 */
const AsicClkDescriptorType clocks_array_8x26[] =
{
        {
...
AsicClockDescriptorArrayType clocks_8x26 = {ADSPPM_ARRAY(clocks_array_8x26)};

/**
 * Arrays of 8x26 register programming clocks
 */
const AdsppmClkIdType regProgClocks_Dml_8x26[]      = {AdsppmClk_Dml_Hclk};
const AdsppmClkIdType regProgClocks_Aif_8x26[]      = {AdsppmClk_Aif_Csr_Hclk};
const AdsppmClkIdType regProgClocks_Slimbus_8x26[]  = {AdsppmClk_Slimbus_Hclk};
//const AdsppmClkIdType regProgClocks_Slimbus2_8x26[] = {AdsppmClk_Slimbus2_Hclk};
//const AdsppmClkIdType regProgClocks_Midi_8x26[]     = {AdsppmClk_Midi_Hclk};
//const AdsppmClkIdType regProgClocks_HwRsmp_8x26[]   = {AdsppmClk_HwRsp_Hclk};
const AdsppmClkIdType regProgClocks_AvSync_8x26[]   = {AdsppmClk_AvSync_Hclk};
const AdsppmClkIdType regProgClocks_Lpm_8x26[]      = {AdsppmClk_Lpm_Hclk};
const AdsppmClkIdType regProgClocks_Sram_8x26[]     = {AdsppmClk_Sram_Hclk};
//const AdsppmClkIdType regProgClocks_Spdif_8x26[]    = {AdsppmClk_Spdif_Hsclk};
//const AdsppmClkIdType regProgClocks_Hdmirx_8x26[]   = {AdsppmClk_Hdmirx_Hclk};
//const AdsppmClkIdType regProgClocks_Sif_8x26[]      = {AdsppmClk_Sif_Hclk};
//const AdsppmClkIdType regProgClocks_Bstc_8x26[]     = {AdsppmClk_Bstc_Hclk};
//const AdsppmClkIdType regProgClocks_Dcodec_8x26[]   = {AdsppmClk_Dcodec_Hclk};
const AdsppmClkIdType regProgClocks_Adsp_8x26[]     = {AdsppmClk_Adsp_Hclk};

/**
 * Array of 8x26 Bus port descriptors arranged by Bus port ID
 */
const AsicBusPortDescriptorType busPorts_array_8x26[] =
{
        {
        ...
        },
        {
                ...
                AdsppmClk_Dml_Hclk, //Bus clock
                {ADSPPM_ARRAY(regProgClocks_Dml_8x26)}, //Array of reg prog clocks
        ...
        },
        {
                ...
                {ADSPPM_ARRAY(regProgClocks_Aif_8x26)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
                ...
                AsicBusPort_AhbI_S, //Connection
                AdsppmClk_Slimbus_Hclk, //Bus clock
                {ADSPPM_ARRAY(regProgClocks_Slimbus_8x26)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
        ...
        },
        {
                ...
                {ADSPPM_ARRAY(regProgClocks_AvSync_8x26)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
                ...
                {ADSPPM_ARRAY(regProgClocks_Lpm_8x26)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
                ...
                {ADSPPM_ARRAY(regProgClocks_Sram_8x26)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
        ...
        },
        {
                ...
                AdsppmClk_Adsp_Hclk, //Bus clock
                {ADSPPM_ARRAY(regProgClocks_Adsp_8x26)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Adsp_Master //Access port
        }
};

AsicBusPortDescriptorArrayType busPorts_8x26 = {ADSPPM_ARRAY(busPorts_array_8x26)};

/**
 * List of supported external bus routes
 */
const AdsppmBusRouteType extBusRoutes_array_8x26[] =
{
        {
...
AsicBusRouteArrayType extBusRoutes_8x26 = {ADSPPM_ARRAY(extBusRoutes_array_8x26)};

const AdsppmBusRouteType mipsBwRoutes_array_8x26[] =
{
        {
...
AsicBusRouteArrayType mipsBwRoutes_8x26 = {ADSPPM_ARRAY(mipsBwRoutes_array_8x26)};

/**
* Array of register programming speeds in byte/sec
*/
const uint64 regProgSpeeds_array_8x26[] =
{
...
AsicRegProgSpeedArrayType regProgSpeeds_8x26 = {ADSPPM_ARRAY(regProgSpeeds_array_8x26)};
 ...
 */
const AsicPowerDomainDescriptorType pwrDomains_array_8x26[] =
{
        {
        ...
        },
        {
                ...
                46, //TZ Done
                {ADSPPM_ARRAY(securityClocks_LPASSCore_8x26)}, //array of Security clocks
        },
        {
...
AsicPwrDescriptorArrayType pwrDomains_8x26 = {ADSPPM_ARRAY(pwrDomains_array_8x26)};
