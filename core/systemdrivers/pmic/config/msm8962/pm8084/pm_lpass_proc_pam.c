...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/pmic/config/msm8962/pm8084/pm_lpass_proc_pam.c#1 $ 
...
unsigned pm8084_num_of_pmic_lpass_nodes[] ={ NPA_ARRAY_SIZE(pm8084_npa_lpass_node_resources) };
