...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/pmic/config/msm8994/pm_lpass_proc_pam.c#1 $ 
...
pm_pam_sensor_dsp_proxy_rails_info []=
{
   ...
   {
      (void*)pm_pam_sensor_dsp_proxy_a_vs2,
      PM_NPA_VREG_VS
   },
};
/* SENSOR_VDD Client */
...
pm_npa_lpass_pam_node_rsrcs[] =
{
   ...
   },
   {
      ...
      NPA_ARRAY_SIZE(pm_lpass_proc_client_dev_deps_sensor_dsp_proxy), // deps count & Deps Node Dependency count
...
uint32 num_of_pm_lpass_nodes[] ={ 5 };
