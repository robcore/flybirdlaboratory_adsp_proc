...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/pmic/config/mpq8092/pm8084/pm_lpass_settings.c#1 $ 

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/07/13   dcf     Added support.
...
static char PM_MODEM_CX_VREG[50] = "/pmic/device/smps/A/smps8/vec";

static unsigned num_of_mx_corners = 6;
static unsigned pm_mx_corners[6] = 
{675000, 950000, 950000, 950000, 1050000, 1050000};
static char PM_MODEM_MX_VREG[50] = "/pmic/device/smps/A/smps8/vec";

PwrResourceInfoType MX_Info[1] = 
{
    {RPM_SMPS_A_REQ, 8, &num_of_mx_corners, pm_mx_corners, PM_MODEM_MX_VREG }// data 1 is the size of the LUT, data 2 is the MX LUT, data3 is the RPM resource string 
};
PwrResourceInfoType CX_Info[1] = 
{
    {RPM_SMPS_A_REQ, 8, &num_of_cx_corners, pm_cx_corners, PM_MODEM_CX_VREG }// data 1 is the size of the LUT, data 2 is the CX LUT, data3 is the RPM resource string.
};
