...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/clock/config/msm8x10/ClockBSP.c#1 $
...
{
   { HAL_CLK_SOURCE_LPAPLL1, 691200 * 1000 },
...
enum
{
  ...
  CLOCK_CPU_CONFIG_576P000_MHZ_PLL9,
