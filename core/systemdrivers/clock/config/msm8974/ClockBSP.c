...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/clock/config/msm8974/ClockBSP.c#1 $
...
{
   { HAL_CLK_SOURCE_LPAPLL1, 680000 * 1000 },
...
static ClockCPUConfigType Clock_QDSP6Config [] =
{
  ...
  },
  {
    ...
    /* .HWVersion         */   { {0}, {0}, DALCHIPINFO_FAMILY_MSM8974 },
    /* .pSourceFreqConfig */   &SourceFreqConfig_LPAPLL1[0]
                             },
  ...
  },
  {
    ...
    /* .HALConfig         */   { HAL_CLK_SOURCE_LPAPLL1, 2, 0, 0, 0 },
    /* .eVRegLevel        */   CLOCK_VREG_LEVEL_HIGH,
    /* .HWVersion         */   { {0}, {0}, DALCHIPINFO_FAMILY_MSM8974_PRO, Clock_8974ProSupport },
