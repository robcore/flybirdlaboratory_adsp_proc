...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/clock/config/msm8994/ClockBSP.c#2 $
...
{
  {  19200 * 1000, { HAL_CLK_SOURCE_XO,       2, 0,  0,  0 }, CLOCK_VREG_LEVEL_LOW },
  {  51200 * 1000, { HAL_CLK_SOURCE_LPAPLL2,  8, 0,  0,  0 }, CLOCK_VREG_LEVEL_LOW },
  { 102400 * 1000, { HAL_CLK_SOURCE_LPAPLL2,  4, 0 , 0,  0 }, CLOCK_VREG_LEVEL_NOMINAL },
...
const ClockMuxConfigType  Q6SPDMClockConfig[] =
{
  {  19200000,     { HAL_CLK_SOURCE_XO,     2,  0,   0,   0 }, CLOCK_VREG_LEVEL_LOW },
  { 0 }
};
...
const ClockFlagInitType ClockFlagInitConfig[] =
{
  ...
  { CLOCK_FLAG_NODE_TYPE_CLOCK,        (void*)"audio_core_slimbus2_lfabif_clk",  CLOCK_FLAG_SUPPRESSIBLE },
...
static const uint32 QDSP6PerfList[] =
{
  ...
  CLOCK_CPU_PERF_LEVEL_2,  /* 249.6 MHz */
  CLOCK_CPU_PERF_LEVEL_3,  /* 441.6 MHz */
  CLOCK_CPU_PERF_LEVEL_4,  /* 595.2 MHz */
  CLOCK_CPU_PERF_LEVEL_5,  /* 748.8 MHz */
};
