...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/clock/hw/mdm9x35/inc/ClockLPASSCPU.h#1 $
 ...
 *                          Fusion. 
 * pPulledSourcedInfo     - Base source configuration table for pulling source frequencies. 
