...
/*  
  ...
  ==================================================================== 
  $Header: //components/rel/core.adsp/2.6.1/systemdrivers/clock/hw/msm8994/src/ClockLPASSVDD.c#1 $
...
{
  /*-----------------------------------------------------------------------*/
  /* Enable/Disable LDO functionality based on the requirements passed in. */
  /*  0: Voltage restriction is not required, allow LDO functioality.      */
  /*  1: Voltage restriction required, do not allow LDO functionality.     */
  /*-----------------------------------------------------------------------*/

  if (nState == CLOCK_SOURCE_REQUIRED)
  {
     Clock_DisableLDO(Clock_GetDrvCtxt());
  }
  else
  {
     Clock_EnableLDO(Clock_GetDrvCtxt());
  }
