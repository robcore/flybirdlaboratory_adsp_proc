...
/*
  ...
  ==================================================================== 
  $Header: //components/rel/core.adsp/2.6.1/systemdrivers/clock/hw/msm8994/src/ClockLPASSDCVS.c#1 $
...
)
{
  ...
  /*-------------------------------------------------------------------------*/
  /* Save the old configuration for use with the eLDO voltage checks.        */
  /*------------------------------------------------------------------------ */

  pLPASSCtxt->QDSP6Ctxt.QDSP6SavedConfig.pCPUConfig = pLPASSCtxt->QDSP6Ctxt.pCPUConfig;
