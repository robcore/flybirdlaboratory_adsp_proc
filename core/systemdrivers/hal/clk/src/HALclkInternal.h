...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/hal/clk/src/HALclkInternal.h#1 $
...
#define HAL_CLK_CHIP_SOC_MPQ8092    6
#define HAL_CLK_CHIP_SOC_MDM9x35    7
#define HAL_CLK_CHIP_SOC_MSM8994    8 /* Check this! */
...
#define HAL_CLK_CHIP_FLAG_MPQ8092   (1 << HAL_CLK_CHIP_SOC_MPQ8092)
#define HAL_CLK_CHIP_FLAG_MDM9x35   (1 << HAL_CLK_CHIP_SOC_MDM9x35)
#define HAL_CLK_CHIP_FLAG_MSM8994   (1 << HAL_CLK_CHIP_SOC_MSM8994)
...
void HAL_clk_AdjustSourceFrequencyInternal( HAL_clk_SourceDescType *pSource, HAL_clk_PLLConfigType *pConfig );
void HAL_clk_GetSourceDeltaInternal       ( HAL_clk_SourceDescType *pSource, HAL_clk_PLLConfigType *pConfig );
void HAL_clk_SelectClockSourceInternal    ( HAL_clk_ClockDomainDescType *pClockDomainDesc, HAL_clk_SourceDescType *pSource );
...
HAL_clk_AdjustSourceFrequencyInternal

Description:
  Internal API that allows fine tuned adjustments on a source that supports
  pulling.

============================================================================== 
 
HAL_clk_GetSourceDeltaInternal

Description:
  Internal API that etrieves the current delta values applied by the
  HAL_clk_AdjustsourceFrequency API.
