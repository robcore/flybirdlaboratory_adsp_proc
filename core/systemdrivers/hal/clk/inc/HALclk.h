...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/hal/clk/inc/HALclk.h#1 $
...
Description:
  Programs delta values for sources that support fine tune adjustments (pulling).
...
Description:
  Retrieves the current delta values programmed by the HAL_clk_AdjustSourceFrequency
  API.
