...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/hal/clk/hw/lpass_v1/src/lcc/HALclkAIFTERMI2SSLV.c#1 $
...
static HAL_clk_ClockDescType HAL_clk_mAIFTERMI2SMSTRClkDomainClks[] =
{
  ...
  },
  {
    ...
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ 0,
    /* .nChipsetFlag     = */ HAL_CLK_CHIP_FLAG_ALL &~ (HAL_CLK_CHIP_FLAG_MSM8974 | HAL_CLK_CHIP_FLAG_MDM9x25)
  },
  {
    ...
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ 0,
    /* .nTestClock       = */ HAL_CLK_CHIP_FLAG_ALL &~ HAL_CLK_CHIP_FLAG_MDM9x25
  },
};
