...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/hal/clk/hw/lpass/src/lcc/HALclkBUS.c#1 $
 ...
 * Functions for controlling common clock functions.
 */
HAL_clk_ClockControlType HAL_clk_mLPMConfigClockControl =
{
  /* .Enable           = */ HAL_clk_GenericEnable,
  /* .Disable          = */ HAL_clk_GenericDisable,
  /* .IsEnabled        = */ HAL_clk_GenericIsEnabled,
  /* .IsOn             = */ HAL_clk_LPMIsOn,
  /* .Reset            = */ HAL_clk_GenericReset,
  /* .IsReset          = */ HAL_clk_GenericIsReset,
  /* .Config           = */ HAL_clk_BusConfig,
  /* .DetectConfig     = */ NULL,
...
static HAL_clk_ClockDescType HAL_clk_mBUSClkDomainClks[] =
{
  ...
  },
  {
    ...
    /* .mRegisters       = */ { HWIO_OFFS(LPASS_AUDIO_CORE_IXFABRIC_CBCR), 0, {0, 0} },
    /* .pmControl        = */ &HAL_clk_mConfigClockControl,
    /* .nTestClock       = */ HAL_CLK_LPASS_TEST_AUDIO_CORE_IXFABRIC_V1_CLK,
  ...
  {
    /* .szClockName      = */ "audio_core_midi_lfabif_clk",
    /* .mRegisters       = */ { HWIO_OFFS(LPASS_AUDIO_CORE_MIDI_LFABIF_CBCR), 0, {0, 0} },
    /* .pmControl        = */ &HAL_clk_mConfigClockControl,
    /* .nTestClock       = */ HAL_CLK_LPASS_TEST_AUDIO_CORE_MIDI_LFABIF_CLK,
  ...
  {
    /* .szClockName      = */ "audio_wrapper_sysnoc_mport_clk",
    /* .mRegisters       = */ { HWIO_OFFS(LPASS_AUDIO_WRAPPER_SYSNOC_MPORT_CBCR), 0, {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_LPASS_TEST_AUDIO_WRAPPER_SYSNOC_MPORT_CLK,
    /* .nChipsetFlag     = */ HAL_CLK_CHIP_FLAG_APQ8084 | HAL_CLK_CHIP_FLAG_MPQ8092
  },
  {
    /* .szClockName      = */ "audio_core_lpm_clk",
    /* .mRegisters       = */ { HWIO_OFFS(LPASS_AUDIO_CORE_LPM_CBCR), 0, {0, 0} },
    /* .pmControl        = */ &HAL_clk_mLPMConfigClockControl,
  ...
  },
  {
    ...
    /* .nChipsetFlag     = */ HAL_CLK_CHIP_FLAG_ALL &~ HAL_CLK_CHIP_FLAG_MSM8x10
  },
  {
  ...
  {
    /* .szClockName      = */ "digcodec_ahb_clk",
    /* .mRegisters       = */ { HWIO_OFFS(LPASS_DIGCODEC_AHB_CBCR), 0, {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_LPASS_TEST_DIGCODEC_AHB_CLK,
...
{
  if((HWIO_INF(LPASS_AUDIO_CORE_LPM_CBCR, CLK_OFF) == 0) &&
     (HWIO_INF(LPASS_AUDIO_CORE_LPM_MEM0_CBCR, CLK_OFF) == 0) &&
     (HWIO_INF(LPASS_AUDIO_CORE_LPM_MEM1_CBCR, CLK_OFF) == 0) &&
     (HWIO_INF(LPASS_AUDIO_CORE_LPM_MEM2_CBCR, CLK_OFF) == 0) &&
     (HWIO_INF(LPASS_AUDIO_CORE_LPM_MEM3_CBCR, CLK_OFF) == 0))
  {
    return TRUE;
  }
  else
