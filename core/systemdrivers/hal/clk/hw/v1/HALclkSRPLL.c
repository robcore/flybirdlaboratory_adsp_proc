...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/hal/clk/hw/v1/HALclkSRPLL.c#1 $
...
HAL_clk_SourceControlType HAL_clk_SRPLLControl =
{
  ...
  /* .SlewConfigPLL       = */ NULL,
  /* .EnableVoteOverride  = */ HAL_clk_SRPLLEnableVoteOverride,
  /* .DisableVoteOverride = */ HAL_clk_SRPLLDisableVoteOverride,
};
...
/* ===========================================================================
**  HAL_clk_SRPLLEnableVoteOverride
**
** ======================================================================== */

static void HAL_clk_SRPLLEnableVoteOverride
(
...
} /* END HAL_clk_SRPLLEnableVoteOverride */


/* ===========================================================================
**  HAL_clk_SRPLLDisableVoteOverride
**
** ======================================================================== */

static void HAL_clk_SRPLLDisableVoteOverride
(
  HAL_clk_SourceDescType      *pSource,
  HAL_clk_ClockDomainDescType *pmClkDomainDesc
)
...
} /* END HAL_clk_SRPLLDisableVoteOverride */
...
static void HAL_clk_SRPLLEnable
(
  HAL_clk_SourceDescType *pSource
)
{
...
static void HAL_clk_SRPLLConfigPLL
(
  HAL_clk_SourceDescType      *pSource,
