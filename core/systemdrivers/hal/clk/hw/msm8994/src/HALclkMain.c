...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/hal/clk/hw/msm8994/src/HALclkMain.c#1 $
...
static HAL_clk_PLLContextType HAL_clk_aPLLContextLPAPLL[] =
{
  ...
  },
 {
    ...
    HAL_CLK_FMSK(LPASS_LPA_PLL_VOTE_LPASSQ6, LPAAUDIO_PRIUS_PLL),
    HAL_CLK_PLL_PRIUS,
    HAL_CLK_FMSK(LPASS_LPA_PLL_VOTE_LPASS_HW, LPAAUDIO_PRIUS_PLL)
  }
};
