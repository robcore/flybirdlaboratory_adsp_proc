...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/hal/clk/hw/lpass_v2/src/HALclkMain.c#1 $
...
static HAL_clk_PLLContextType HAL_clk_aPLLContextLPAPLL[] =
{
  ...
  },
  {
    ...
    HAL_CLK_FMSK(LPASS_LPA_PLL_VOTE_LPASSQ6, Q6SS_PLL),
    HAL_CLK_PLL_PRIUS,
    HAL_CLK_FMSK(LPASS_LPA_PLL_VOTE_LPASS_HW, Q6SS_PLL)
  },
 {
    HWIO_OFFS(LPASS_LPAAUDIO_PRIUS_PLL_MODE),
    HAL_CLK_FMSK(LPASS_LPA_PLL_VOTE_LPASSQ6, Q6_PLL),
    HAL_CLK_PLL_PRIUS,
    HAL_CLK_FMSK(LPASS_LPA_PLL_VOTE_LPASS_HW, Q6_PLL)
  }
};
