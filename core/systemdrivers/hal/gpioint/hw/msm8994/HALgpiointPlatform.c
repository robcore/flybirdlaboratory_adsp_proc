...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/hal/gpioint/hw/msm8994/HALgpiointPlatform.c#1 $
...
void HAL_gpioint_PlatformInitEarly (HAL_gpioint_PlatformType *pmPlatform)
{
  ...
  pmPlatform->pmCtl.nCfgRegOffset                  = 0x10;                                                             
