...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/hal/gpioint/src/HALgpioint.c#1 $
...
extern uint32 nHalTargetProcVersion;
...
)
{
  ...
  nHalTargetProcVersion = (uint32)pTargetData->nHalTargetProcVersion;
