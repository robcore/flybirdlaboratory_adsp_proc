...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/InterruptController/config/8994/InterruptConfigData.c#1 $
...
static InterruptConfigType InterruptConfigs[] =
{
  ...
  {96, "crypto_core_irq[1:0]" },
  {96, "crypto_core_irq[1]" },
  {97, "crypto_bam_irq[1:0]" },
  {97, "crypto_bam_irq[1]" },
  {98, "crypto_core_irq[1:0]" },
