...
$Header: //components/rel/core.adsp/2.6.1/systemdrivers/GPIOInt/config/kernel/msm8994/GPIOInt_ConfigData.c#1 $
...
GPIOIntConfigMapType interrupt_config_map[] =
{
  ...
  {23,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
  {24,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
  {43,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
  {44,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
  ...
  {85,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
  {86,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
  ...
  {42,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
  {26,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
  {40,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/
  ...
  {90,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/   
  {63,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/   
  {89,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/   
  {58,          HAL_GPIOINT_SUMMARY,         GPIOINT_NONE,0}, /* Sensors GPIO in MultiPD is a summary interrupt*/   
};
