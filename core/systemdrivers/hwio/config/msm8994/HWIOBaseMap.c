...
/*
  ...
  $Header: //components/rel/core.adsp/2.6.1/systemdrivers/hwio/config/msm8994/HWIOBaseMap.c#1 $
...
static HWIOModuleType HWIOModules_QDSS_CPU_QDSS_CPU[] =
{
  ...
  { "QDSS_CPU_CONDOR_ATB_FUNNEL_CONDOR_ATB_FUNNEL_CXATBFUNNEL_128W8SP", 0x00360000, 0x00001000 },
  { NULL, 0, 0 }
};
...
static HWIOModuleType HWIOModules_QDSS_QDSS_TOTAL[] =
{
...
{
  { "SYSTEM_NOC",                                  0x00000000, 0x00005880 },
  { NULL, 0, 0 }
};
...
HWIOPhysRegionType HWIOBaseMap[] =
{
  ...
  },
  {
    ...
    0x00080000,
    (DALSYSMemAddr)QDSS_QDSS_TOTAL_BASE,
    HWIOModules_QDSS_QDSS_TOTAL
  },
  {
    "CLK_CTL",
