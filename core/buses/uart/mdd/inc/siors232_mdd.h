...
/*===========================================================================
  ...
  $Header: //components/rel/core.adsp/2.6.1/buses/uart/mdd/inc/siors232_mdd.h#1 $ $DateTime: 2014/10/16 12:45:40 $ $Author: pwbldsvc $
...
void                           siors_mdd_powerdown( sio_mdd_port_type*, sio_pd_reason_type reason );
