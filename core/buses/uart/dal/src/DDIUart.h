...
$Header: //components/rel/core.adsp/2.6.1/buses/uart/dal/src/DDIUart.h#1 $
...
// uint32 while passing through the UART DAL layer and recast to the appropriate data type
...
typedef struct
{
   uint32 uart_irq;                                        // IRQ for UART generated events
   uint32 rx_irq;                                          // IRQ for the raw RX signal
