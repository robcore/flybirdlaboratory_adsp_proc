...
$Header: //components/rel/core.adsp/2.6.1/buses/uart/hal/inc/HALuart.h#1 $
...
struct HALUartObject
{
   ...
   uint32                base;         // base of UART register block (virtual address)
   uint32                physical;     // base of UART register block (physical address)
...
struct HALUartFcnTable
{
   ...
   void   (*GetFIFOPhysAddrs)           (HALUartObject *uart, uint32 *rx_fifo, uint32 *tx_fifo);
...
==================================================================================================*/
static __inline
void HALuart_GetFIFOPhysAddrs(HALUartObject *uart, uint32 *rx_fifo, uint32 *tx_fifo)
{
...
==================================================================================================*/
static __inline
void HALuart_InitObject(HALUartObject *uart, HALUartType type, uint32 virt_addr, uint32 phys_addr)
{
