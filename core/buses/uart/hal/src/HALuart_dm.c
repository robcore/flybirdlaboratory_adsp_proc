...
$Header: //components/rel/core.adsp/2.6.1/buses/uart/hal/src/HALuart_dm.c#1 $
...
static void   HALuart_dm_GetFIFOPhysAddrs           (HALUartObject *uart, uint32 *rx_fifo,
                                                                          uint32 *tx_fifo);
...
==================================================================================================*/
static void HALuart_dm_GetFIFOPhysAddrs(HALUartObject *uart, uint32 *rx_fifo, uint32 *tx_fifo)
{
