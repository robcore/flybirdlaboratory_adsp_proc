...
$Header: //components/rel/core.adsp/2.6.1/buses/uart/hal/src/HALuart_bam.c#1 $
...
static void   HALuart_bam_GetFIFOPhysAddrs           (HALUartObject *uart, uint32 *rx_fifo,
                                                                           uint32 *tx_fifo);
...
static uint32 HALuart_bam_ReadRxFifo(HALUartObject *uart, uint8 *ptr, uint32 num_bytes)
{
   ...
   if ( (uint32)ptr & 0x03 )  // buffer is not 32-bit word aligned
   {
...
==================================================================================================*/
static void HALuart_bam_GetFIFOPhysAddrs(HALUartObject *uart, uint32 *rx_fifo, uint32 *tx_fifo)
{
