...
$Header: //components/rel/core.adsp/2.6.1/buses/slimbus/src/qmi/slimbus_qmi_svc.c#1 $
...
static const uint32 uaDevIds[] = { DALDEVICEID_SLIMBUS_1 };
    ...
    case QMI_SLIMBUS_POWER_REQ_V01:
    {
      ...
      else
      {
        ...
        if( NULL != client_info->hSB )
        {
          ...
          {
            DalDevice_Open(client_info->hSB, DAL_OPEN_SHARED);
          }
...
void slimbus_qmi_init(void)
{
  ...
  qurt_thread_attr_set_priority(&slimbus_qmi_service_attr, 10);
