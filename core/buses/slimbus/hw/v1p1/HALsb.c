...
/*============================================================================
  ...
  $Header: //components/rel/core.adsp/2.6.1/buses/slimbus/hw/v1p1/HALsb.c#1 $
...
{  
  ...
  if(SB_MAXn(PGD_PC_CFGn) >= uPcNum)
  {
    SB_HWIO_OUTFI(hHandle,PGD_PC_CFGn,uPcNum,PORT_SEL,uPortNum);
  }
}
                              ...
                              uint32 uPcNum)
{
  ...
  if(SB_MAXn(PGD_PC_CFGn) >= uPcNum)
  {
    uPortNum =  SB_HWIO_INFI(hHandle,PGD_PC_CFGn,uPcNum,PORT_SEL);
  }
  return uPortNum;
}
