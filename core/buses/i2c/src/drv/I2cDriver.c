...
/*=========================================================================
  ...
  $Header: //components/rel/core.adsp/2.6.1/buses/i2c/src/drv/I2cDriver.c#2 $
...
)
{
   ...
   case I2cDrvCmd_Vote_PnocOn:
      pVoteData = (I2cDrvPnocVoteData *)pData;
      if ((NULL == pVoteData) || (0 == pVoteData->uPnocIb)) {
         res = I2CDRV_ERR_INVALID_CMD_DATA;
         break;
      }
      
      res = I2cPlat_AddPnocVote(&pDesc->plat, pVoteData->uPnocIb, pVoteData->uPnocAb); 
      if ( I2C_RES_SUCCESS == res ) { 
