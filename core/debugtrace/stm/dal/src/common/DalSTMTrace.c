/*=============================================================================
  Copyright (c) 2009 Qualcomm Technologies Incorporated.
           All Rights Reserved.
                  ...
                  $Header: //components/rel/core.adsp/2.6.1/debugtrace/stm/dal/src/common/DalSTMTrace.c#1 $
=============================================================================*/
...
static int QDSSGetSTMVirtualAddr(uint32 physicalAddr,
                                 uint32 *pVirtualAddr) 
{
   int nErr= DAL_ERROR;
 ...
 */
#define QDSS_STM_BASE_PHYS_ADSP   (0xFA0C0000)
#define QDSS_STM_BASE_PHYS_SENSOR (0xFA0F0000)


int QDSSGetSTMBaseAddrADSP(uint32 *pVirtualAddr) 
{
   return QDSSGetSTMVirtualAddr(QDSS_STM_BASE_PHYS_ADSP,pVirtualAddr);
}

int QDSSGetSTMBaseAddrSensor(uint32 *pVirtualAddr) 
{
   return QDSSGetSTMVirtualAddr(QDSS_STM_BASE_PHYS_SENSOR,pVirtualAddr);
}
