...
if os.path.exists('./build/ms/RA_FunctionStackSizes.csv'):
		if os.path.exists('./build/ms/RA_FunctionStackSizes_sensor.csv'):
				os.remove('./build/ms/RA_FunctionStackSizes_sensor.csv')
		os.renames('./build/ms/RA_FunctionStackSizes.csv','./build/ms/RA_FunctionStackSizes_sensor.csv')
		...
		if flag == 0:
				if sys.argv[1] == 'mpd':
						if os.path.exists('%s'%sys.argv[2]):
								hexagon_sensor_csv=open("./build/ms/RA_FunctionStackSizes_sensor.csv","r")
