...
set Crashman_Version= External_Release_1.14
...
echo ************************************
if exist C:\T32\bin\windows64 ( start C:\T32\bin\windows64\t32mqdsp6.exe -c %CurrDirectory%\config_sim_usb.t32, "%CurrDirectory%\DSP_load_memorydump_crashman_click.cmm" %targetid% %INDumpPath% %OUTDumpPath% %CRM_buildpath% %CurrDirectory% %CustomerPath% %BinaryLength% %adspstartadd% %choice1% %DumpCheckFlag% %SlpiFlag% %Qube_pa_guestos_click%
) else ( start C:\T32\t32mqdsp6.exe -c %CurrDirectory%\config_sim_usb.t32, "%CurrDirectory%\DSP_load_memorydump_crashman_click.cmm" %targetid% %INDumpPath% %OUTDumpPath% %CRM_buildpath% %CurrDirectory% %CustomerPath% %BinaryLength% %adspstartadd% %choice1% %DumpCheckFlag% %SlpiFlag% %Qube_pa_guestos_click%
)
