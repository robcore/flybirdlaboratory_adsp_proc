...
$Header: //components/rel/avs.adsp/2.6.1/elite/qurt_elite/src/qurt_elite_thread.cpp#3 $
   ...
   qurt_thread_attr_set_name(&attr, (char*)pzThreadName);
    ...
    if (QURT_EOK != ret)
    {
       *pTid = ret;
       ...
       // If there is failure to create thread, clear thread state and return EFAILED.
