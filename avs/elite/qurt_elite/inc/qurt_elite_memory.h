...
$Header: //components/rel/avs.adsp/2.6.1/elite/qurt_elite/inc/qurt_elite_memory.h#3 $
...
/** Maximum number of heaps supported in the Elite framework. @newpage */
...
typedef enum
{
   ...
   /**< Heap value is out of range. @newpage */ //keep at end
...
/**
  ...
  This macro takes additional arguments that can be passed to the
...
/**
  Deinitializes the heap manager of a specified heap ID.
...
/**
  Initializes the heap manager's heap table entries.
...
/** Deinitializes the variables used for maintaining memory usage statistics for
  AVS and non-AVS threads.
