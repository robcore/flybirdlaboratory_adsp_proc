...
$Header: //components/rel/avs.adsp/2.6.1/elite/qurt_elite/inc/qurt_elite_timer.h#3 $

when       who     what, where, why
--------   ---     -------------------------------------------------------
09/08/01   sw      (Tech Pubs) Merged Doxygen comments from 2.4; edited
...
typedef struct {
    ...
    /**< Flag that indicates whether the timer is created. */
...
/** QuRT_Elite timer attributes structure. The client sets the value, which
    is passed into qurt_elite_timer_create/create2.
*/
typedef struct {
    boolean is_deferrable_group;
    /**< Specifies whether the timer is deferrable.
...
/**
  ...
  @dependencies
  The timer object must have been created using qurt_elite_timer_create() or
...
/**
  ...
  @detdesc
  The caller must allocate the memory for the timer strucure and pass the
  pointer to this function.
  @par
  After this function, call the appropriate start functions based on
  the type of timer.
  @par
  This function creates a timer in the default deferrable timer group.
...
/** Creates a timer with attributes (pTimerAttr) passed in by the caller.
  ...
  pointer to this function.
  @par
  After this function, call the appropriate start functions based on the type
  of timer.
...
/**
  ...
  @dependencies
  The timer must have been created using qurt_elite_timer_create() or
  qurt_elite_timer_create2().
*/
