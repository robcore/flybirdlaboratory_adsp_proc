...
$Header: //components/rel/avs.adsp/2.6.1/elite/qurt_elite/inc/qurt_elite_diag.h#3 $
...
/** Lowest debug message level to be shown. This is valid only in SIM mode. */
...
Use diagnostic-defined MSG_N macros and legacy debug priorities.
@{ */
...
/** Print macro for debugging. This prints to the QuRT buffer. */
...
/**
  ...
  diagnostic service. The buffer size must be a multiple of 8 bytes.
