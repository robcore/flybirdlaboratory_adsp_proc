...
/** @ingroup eliteshm_func_flush_cache2
  ...
  For more information on the mapping modes, refer to @xhyperref{Q6,[Q6]}.
  ...
  @dependencies
  None.
*/ /* Q6 = Hex Multimedia: QuRT_Elite API Interface Spec for 2.4 (80-NF769-7) */
...
/** @ingroup eliteshm_func_map_cmd_hdlr
  ...
  - ASM_CMD_SHARED_MEM_MAP_REGIONS (refer to @xhyperref{Q9,[Q9]})
  - ADM_CMD_SHARED_MEM_MAP_REGIONS (refer to @xhyperref{Q9,[Q9]})
  - AFE_SERVICE_CMD_SHARED_MEM_MAP_REGIONS (refer to @xhyperref{Q11,[Q11]})
  - VOICE_CMD_SHARED_MEM_MAP_REGIONS (refer to @xhyperref{Q10,[Q10]})
  ...
  @dependencies
  None.
*/ /* Q9 = Hex Multimedia: Audio API Interface Spec for 2.4 (80-NF768-1)
     Q10 = Hex Multimedia: Voice API Interface Spec for 2.4 (80-NF768-2)
     Q11 = Hex Multimedia: AFE API Interface Spec for 2.4 (80-NF768-3) */
...
/** @ingroup eliteshm_func_unmap_cmd_hdlr
  Processes the following commands:
  - ASM_CMD_SHARED_MEM_UNMAP_REGIONS (refer to @xhyperref{Q9,[Q9]})
  - ADM_CMD_SHARED_MEM_UNMAP_REGIONS (refer to @xhyperref{Q9,[Q9]})
  - AFE_SERVICE_CMD_SHARED_MEM_UNMAP_REGIONS (refer to @xhyperref{Q11,[Q11]})
  - VOICE_CMD_SHARED_MEM_UNMAP_REGIONS (refer to @xhyperref{Q10,[Q10]})
