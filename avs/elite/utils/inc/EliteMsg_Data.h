...
/** Indicates that the rest of the payload is in a media format defined in 
    @xhyperref{Q9,[Q9}.
*/ /* Q9 = Hex Multimedia: Audio API Interface Spec for 2.4 (80-NF769-1) */
...
/** Indicates that this EOS originates from the client's EOS command.

    @msgpayload{elite_msg_data_eos_apr_t}
    @wktablens{weak__elite__msg__data__eos__apr__t}
...
/** Indicates that this Tx-path EOS is generated internally -- the EOS can be
  ...
  @wktable{weak__elite__msg__data__eos__header__t} @newpage
   */
...
/** Indicates that this End of Tone originates from the DTMF stream leg
  ...
  @par EOS information (elite_msg_data_eos_info_t)
  @wktablens{weak__elite__msg__data__eos__info__t} @newpage
   */
...
/** Multichannel PCM media format message type.
  ...
  @wktable{weak__elite__multi__channel__pcm__fmt__blk__t}
 */
...
/** Compressed media format message type.
  ...
  @wktable{weak__elite__compressed__fmt__blk__t} @newpage
 */
...
/** @} */ /* end_name */
   ...
   */
   typedef struct
   {
      ...
      /**< Format of the rest of the payload. When set to
           ...
           defined in @xhyperref{Q9,[Q9]}. */

      uint32_t        unMediaFormatID;
      /**< Media format ID as defined in @xhyperref{Q9,[Q9]}. */
   ...
   */
   typedef struct
   {
      ...
      /**< Operation code for the EOS event as defined in @xhyperref{Q9,[Q9]}. */
   ...
   */
   ...
   /** Under normal conditions, the service that receives this message is
       ...
       flushes data input before it can be processed, the service is instructed
   ...
   typedef struct
      {
         ...
         uint32_t       token_lsw;
         /**< Lower 32 bits of the of the mark buffer token. */

         uint32_t       token_msw;
         /**< Upper 32 bits of the of the mark buffer token. */
   ...
   */
   typedef struct
   {
	  ...
	  /**< Size of the following payload.
           ...
           The payload format is (possibly) multiple sets of asm_stream_param_data_t
...
struct elite_compressed_fmt_blk_t
{
   ...
   /**< Format of the compressed data.
        ...
        This parameter uses the ASM_MEDIA_FMT* definitions in adsp_media_fmt.h. */
};
