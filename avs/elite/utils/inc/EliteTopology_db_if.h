...
/** @ingroup elite_topodb_deinit_global
  Deinitializes the global topology database. None of the topology database
  ...
  @dependencies
  topo_db_init() must have been called, and it must have returned ADSP_EOK.
*/
...
/** @ingroup elite_topodb_add_topo
  ...
  audproc_topology_definition_t (refer to @xhyperref{Q9,[Q9]})

  @param[in] client_type           Type of the elite service that will use the
                                   topologies being added.
  @param[in] num_topologies        Number of topologies being added.
  @param[in] topology_definitions  Array of topology definitions to be added.
                                   The array must have num_topologies elements. \n
...
/** @ingroup elite_topodb_get_topo
  ...
  @param[in]  client_type   Type of elite service requesting the topology
                            definition.
  @param[in]  topology_id   ID of the topology for which the definition is
                            requested.
  @param[out] topology_ptr  Double pointer that will be filled with a pointer
                            to the topology definition corresponding to the
                            given topology ID.

  @return
  ADSP_EOK -- Success.
  @par
  Error code -- Topology definition could not be retrieved. In this case,
...
/** @ingroup elite_topodb_mod_pres
  ...
  @param[in] topology_id    ID of the topology for which the definition is
                            requested.
  @param[in] module_id      ID of the module to be checked for.
