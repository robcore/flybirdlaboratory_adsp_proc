...
$Header: //components/rel/avs.adsp/2.6.1/api/audio/inc/adsp_asm_session_commands.h#3 $
...
/** @addtogroup asm_session_deprecated
@{ */
...
/** @} */ /* end_addtogroup asm_session_deprecated */

/** @ingroup asmsess_constants_macros
  ...
  @detdesc
    ...
    purposes. It is supported only in the following modes:
     ...
     - On the playback path (Pull mode, ULL, Gapless, and regular playback),
       ...
       The value of the delay might vary depending on the time of the query.
...
/** @ingroup asmsess_cmd_set_matrix_rtr_par
  ...
  @apr_msgpayload{asm_session_cmd_set_mtmx_strtr_params_v2_t}
    If data_payload_addr=NULL, immediately following is a series of
    <b>Parameter data variable payload</b> structures
    (%asm_session_param_data_v2_t), whose total size is data_payload_size
    bytes.
...
struct asm_session_cmd_get_mtmx_strtr_params_v2_t
{
   ...
   /**< Upper 32 bits of the 64-bit data payload address.
        ...
        contain the entire <b>Parameter data variable payload</b>
        (%asm_session_param_data_v2_t). */
...
/** @ingroup asmsess_resp_matrix_rtr_par
  ...
  @apr_msgpayload{asm_session_cmdrsp_get_mtmx_strtr_params_v2_t}
    For in-band, immediately following this structure is
    %asm_session_param_data_v2_t, which contains the matrix/stream router
    parameter data (see <b>Parameter data variable payload</b>).
