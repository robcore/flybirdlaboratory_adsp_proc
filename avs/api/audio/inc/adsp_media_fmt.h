...
$Header: //components/rel/avs.adsp/2.6.1/api/audio/inc/adsp_media_fmt.h#3 $
...
/** @ingroup asmstrm_mediafmt_mchan_pcmv2
...
/** @cond OEM_only */
/** @addtogroup asm_mediafmt_deprecated
@{ */
...
/** @} */ /* end_addtogroup asm_mediafmt_deprecated */
/** @endcond */
...
struct asm_dts_enc_cfg_t
{
    ...
    /**< Channel mapping array of size 16.
         ...
         Channel[i] mapping describes channel i. Each element i of the array
         describes channel i inside the buffer where 0 @le i < num_channels.
         An unused channel is set to zero. Only the first num_channels
         elements are valid.
...
struct asm_ddp_enc_cfg_t
{
    ...
    /**< Channel mapping array of size 16.
         ...
         Channel[i] mapping describes channel i. Each element i of the array
         describes channel I inside the buffer where 0 @le I < num_channels.
         An unused channel is set to zero. Only first num_channels elements
         are valid.
...
/** @ingroup asmstrm_mediafmt_mchan_pcmv3
...
/** @ingroup asmstrm_mediafmt_alac
    ...
    present in the bitstream. These constants describe the channel layout
    (for more information, refer to @xhyperref{S4,[S4]}).
@verbatim
enum
  {
  ...
  /* following channel layout of the bitstream is defined in ALACAudioTypes.h)*/
    ...
    /**< Indicates whether channel layout information is present in the
         ...
         - Constants are extracted when channel layout information is
           present; for details, see <b>channelLayoutTag constants</b> on the
           next page
           @tablebulletend */
}
#include "adsp_end_pack.h"
