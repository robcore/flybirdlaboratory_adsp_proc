...
/** Creates a new paired Tx/Rx voice call stream.
  ...
  @apr_msgpayload{vsm_create_session_t}
...
/** Sets the vocoder media type on both Tx and Rx streams in a paired session.
  ...
  @apr_msgpayload(vsm_set_media_type_t)
...
/** @ingroup vsm_cmd_reconfigure_session
  ...
  @apr_msgpayload{vsm_reinit_session_t}
...
/** @ingroup vsm_cmd_route_stream
  ...
  @apr_msgpayload{vsm_routing_config_t}
...
/** @ingroup vsm_evt_oob_send_pkt_to_client
  ...
  @dependencies
	...
	@par
	The Packet Exchange mode must have been configured for the Out-of-band mode of
	transfer.
	@par
...
/** @ingroup vsm_evt_send_enc_packet
  ...
  @apr_msgpayload{vsm_send_enc_packet_t}
...
/** @ingroup vsm_evt_send_dec_packet
  ...
  @apr_msgpayload{vsm_send_dec_packet_t}
...
/** @ingroup vsm_evt_oob_request_pkt_from_client
  ...
  @detdesc
    ...
    vocoders in packet-switched networks can vary@if OEM_only, based on whether
    time warping is enabled (see #VSM_CMD_SET_TIMEWARP)@endif.
...
/** Sets minimum and maximum frame rates on the encoder. This command applies
  ...
  @apr_msgpayload{vsm_enc_set_minmax_rate_t}
...
/** @ingroup vsm_cmd_set_encoding_rates
  ...
  @apr_msgpayload{vsm_enc_set_rate_t}
...
/** @ingroup vsm_cmd_set_rate_modulation
  ...
  @apr_msgpayload{vsm_enc_set_rate_mod_t}
...
/** @ingroup vsm_cmd_set_dtx_mode
  ...
  @apr_msgpayload{vsm_enc__set__dtx__mode_t}
...
/** @ingroup vsm_cmd_set_time_warp
  ...
  @apr_msgpayload{vsm_set_timewarp_t}
  ...
  @detdesc
    ...
    ignored by non-4GV codecs. @newpage
...
/** Sets the Teletype (TTY) mode.
  ...
  @apr_msgpayload{vsm_set_tty_mode_t}
...
/** @cond OEM_only */
/** @ingroup vsm_cmd_set_oob_tty_mode
    Sets the TTY mode for the out-of-band method of character exchange.
  ...
  @apr_msgpayload{vsm_set_outofband_tty_mode_t}
  ...
  @dependencies
    A valid session must have been created, and it must be in the Stop state.
    @par
    In-band and out-of-band TTY modes cannot be enabled simultaneously.
*/
...
/** @weakgroup weak_vsm_outofband_set_tty_mode_t
@{ */
...
/** @cond OEM_only */
/** @ingroup vsm_evt_oob_tty_tx_char_det
    Indicates that a character is detected on the Tx path for
    out-of-band TTY.
  ...
  @apr_msgpayload{vsm_evt_outofband_tty_tx_char_t}
    @table{weak__vsm__evt__outofband__tty__tx__char__detected__t}

  @description
    The stream sends this event to the client when a TTY character is
    detected on the Tx path. The encoder input is replaced with silence, to
    prevent inband transmission of the TTY tone.
      @par
    This event is generated during out-of-band TTY processing.
    Therefore, the client must enable out-of-band TTY processing to receive
    this event.
  ...
  @dependencies
    A valid session must have been created, and it must be in the Run state.
      @par
    A #VSM_CMD_OUTOFBAND_SET_TTY_MODE command must be issued before this
...
{
   uint16_t tty_char;
   /**< Character that is detected on the Tx path.

        @values Character from the Baudot character set, in UTF-8
                representation and int16 format */
}
#include "adsp_end_pack.h"
;
...
/** @cond OEM_only */
/** @ingroup vsm_evt_oob_tty_rx_char_push
    Indicates that a new character must be rendered on the Rx path for
    out-of-band TTY.
  ...
  @apr_msgpayload{vsm_evt_outofband_tty_rx_char_push_t}
    @table{weak__vsm__evt__outofband__tty__rx__char__push__t}

  @description
    The client sends this event to the stream, and it can start pushing Rx
    characters once the session is set to the Run state.
      @par
    The client generates this event during out-of-band TTY processing.
    Therefore, the client must enable out-of-band TTY processing before
...
{
   uint16_t tty_char;
   /**< Character to be rendered on the Rx path.
...
/** @cond OEM_only */
/** @ingroup vsm_evt_oob_tty_rx_char_acc
    Indicates that the character render request is accepted on the Rx path
    for out-of-band TTY.
  ...
  @description
    The stream sends this event to the client. After the Rx character
    modulation is accepted, the downlink speech is replaced with the
    corresponding TTY tone.
      @par
    The stream generates this event in response to the
    #VSM_EVT_OUTOFBAND_TTY_RX_CHAR_PUSH event during out-of-band TTY
    processing.
  ...
  @dependencies
    A valid session must have been created, and it must be in the Run state.
      @par
    The client must issue a #VSM_EVT_OUTOFBAND_TTY_RX_CHAR_PUSH event 
    before this VSM_EVT_OUTOFBAND_TTY_RX_CHAR_ACCEPTED event can be generated
    in response with the same client token.
*/
#define VSM_EVT_OUTOFBAND_TTY_RX_CHAR_ACCEPTED  ( 0x0001105e )

/** @ingroup vsm_evt_oob_tty_error
    Generated when a recent character render request cannot be
    accepted on the Rx path for out-of-band TTY. The stream sends this event
    to the client.
  ...
  @dependencies
    A valid session must have been created, and it must be in the Run state.
      @par
    The client must first issue a #VSM_EVT_OUTOFBAND_TTY_RX_CHAR_ACCEPTED
    event before this VSM_EVT_OUTOFBAND_TTY_ERROR event can be generated in
    response with the same client token.
*/
...
/** Starts and stops DTMF generation.
  ...
  @apr_msgpayload{vsm_set_dtmf_generation_t}
  ...
  @detdesc
    ...
    @par
    @keep{4} If a stream is to be closed before the requested tone duration
...
/** @ingroup vsm_evt_dtmf_ended
  ...
  @apr_msgpayload{vsm_evt_dtmf_generation_ended_t}
...
/** Configures DTMF detection in the Rx direction.
  ...
  @apr_msgpayload{vsm_set_rx_dtmf_detection_t}
...
/** @ingroup vsm_evt_rx_dtmf_detected
  ...
  @apr_msgpayload{vsm_rx_dtmf_detected_t}
...
/** Starts a recording session on a specified stream by writing PCM samples
  ...
  @apr_msgpayload{vsm_start_record_v2_t}
  ...
  @sa
    #VSM_CMD_STOP_RECORD
*/ /* Q6 = Hex Multimedia: AFE API Interface Spec for 2.4 (80-NF769-3)*/
...
/** @ingroup vsm_cmd_start_playback_session
  ...
  @apr_msgpayload{vsm_start_playback_t}
...
/** Sets the vocoder Packet Exchange mode on the stream session.
  ...
  @apr_msgpayload {vsm_set_pkt_exchange_mode_t}
...
/** @ingroup vsm_cmd_set_stream_pp_sample_rate
  ...
  @apr_msgpayload {vsm_set_samp_rate_t}
...
/** @ingroup vsm_cmd_set_oob_pkt_exchg_config
  ...
  @apr_msgpayload{vsm_config_packet_exchange_t}
...
/** The format of the data in shared memory. Following this structure is the
    packet payload of signed bitstream data.
*/
...
/** @cond OEM_only */
/** @ingroup vsm_cmd_set_timing_params
  ...
  @apr_msgpayload{vsm_set_timing_params_t}
...
struct vsm_set_timing_params_t
{
   ...
   /**< Offset from the VFR for the voice device uplink to deliver
        processed data to the encoder.
        ...
        Logically, this offset belongs to the device only, but the stream also
        needs it to support in-call music playback where a timing command must
        be sent from the VSM to the VPM. */
}
#include "adsp_end_pack.h"
;
...
/** @ingroup vsm_cmd_get_kpps
  ...
  @return
    APRV2_IBASIC_RSP_RESULT (refer to @xhyperref{Q3,[Q3]}) .
	@par
    #VSM_RSP_GET_KPPS_ACK in response to this command. 
...
/** @ingroup vsm_resp_get_kpps_ack
  ...
  @apr_msgpayload{vsm_get_kpps_ack_t}
...
/** @cond OEM_only */
/** @ingroup vsm_cmd_set_timing_params_2
  ...
  @apr_msgpayload{vsm_set_timing_params_v2_t}
    @table{weak__vsm__set__timing__params__v2__t}
...
/** @weakgroup weak_vsm_set_timing_params_v2_t
@{ */
/* Payload of the VSM_CMD_SET_TIMING_PARAMS_V2 command, which sets the
...
struct vsm_set_timing_params_v2_t
{
   ...
   /**< Offset from the VFR to request the vocoder packet from the client. The
        ...
        The offset is determined by the client based on when it is ready for
        the packet to be pulled. */
   ...
   uint16_t decpp_offset;
   /**< Offset from the VFR for the voice stream downlink to begin
        postprocessing incoming data from the decoder.

        @values 0 to 20000 microseconds with 1-microsecond granularity

        The offset is forward calculated from the decode begin offset, and it
        considers room for decoder processing times. This offset is used
        only for PS (#VFR_NONE) and when the time warping framework is enabled.
        The calculation considers clock settings and system load factors. */
...
#include "adsp_end_pack.h"
;
/** @} */ /* end_weakgroup weak_vsm_set_timing_params_v2_t */
/** @endcond */

/** @cond OEM_only */
/** @addtogroup vsm_cmd_set_eamr_chg_det
@{ */
/**  Enables/disables Enhanced AMR (EAMR) mode detection.
   This command is expected before every call.
  ...
  @apr_msgpayload{vsm_set_eamr_mode_change_detection_t}
    @table{weak__vsm__set__eamr__mode__change__detection__t}
...
/** Valid values for enabling/disabling EAMR mode detection.
*/
typedef enum
{
    VSM_EAMR_MODE_CHANGE_DETECTION_DISABLE = 0,  /**< Disable EAMR mode detection. */
    VSM_EAMR_MODE_CHANGE_DETECTION_ENABLE        /**< Enable EAMR mode detection. */
} vsm_set_eamr_mode_t;

/** @} */ /* end_addtogroup vsm_cmd_set_eamr_chg_det */
...
{
    uint32_t enable;
    /**< Specifies whether EAMR mode detection is enabled.

         @values
         - #VSM_EAMR_MODE_CHANGE_DETECTION_DISABLE
         - #VSM_EAMR_MODE_CHANGE_DETECTION_ENABLE @tablebulletend */
}
#include "adsp_end_pack.h"
;
...
/** @cond OEM_only */
/** @addtogroup vsm_evt_eamr_mode_chgd
@{ */
/**  Indicates a change in the internal operating mode of the EAMR decoder.
  ...
  @apr_msgpayload{vsm_eamr_mode_changed_t}
    @table{weak__vsm__eamr__mode__changed__t}

  @description
    The VSM sends this event to the CVS whenever a sample rate change occurs.
    @par
    The initial sampling rate is assumed to be 8K. The first notification is
    sent when the decoder detects a watermark in the packet.
    @par
    The sampling rate continues across handovers.
...
/** Valid values for EAMR operating modes.
*/
typedef enum
{
    VSM_EAMR_MODE_NARROWBAND = 0,   /**< Mode is narrowband. */
    VSM_EAMR_MODE_WIDEBAND          /**< Mode is wideband. */
} vsm_eamr_mode_t;

/** @} */ /* end_addtogroup vsm_evt_eamr_mode_chgd */
...
{
    uint32_t mode;
    /**< Specifies the new operating mode.

         @values
         - #VSM_EAMR_MODE_NARROWBAND
         - #VSM_EAMR_MODE_WIDEBAND @tablebulletend */
}
#include "adsp_end_pack.h"
;
...
/** @ingroup vsm_cmd_get_delay
    ...
    of all modules independently on the Tx and Rx paths. To ensure accurate
    delay values, this command must be issued only after a valid media type
    has been sent.
...
/** @ingroup vsm_resp_get_delay_ack
  ...
  @apr_msgpayload{vsm_get_delay_ack_t}
...
/** @ingroup vsm_cmd_register_evt
    Registers for an event from the VSM.
    Currently, the #VSM_EVT_VOC_OPERATING_MODE_UPDATE event is supported.

  @apr_hdr_fields
    Opcode -- VSM_CMD_REGISTER_EVENT
    @par
    Dst_port -- Handle to the session

  @apr_msgpayload{vsm_cmd_register_event_t}
    @table{weak__vsm__cmd__register__event__t}
...
/** @ingroup vsm_cmd_unregister_evt
    Unregisters for a previously registered event from the VSM.

  @apr_hdr_fields
    Opcode -- VSM_CMD_UNREGISTER_EVENT
    @par
    Dst_port -- Handle to the session
...
/** @weakgroup weak_vsm_cmd_register_event_t
@{ */
...
#include "adsp_end_pack.h"
;
/** @} */ /* end_weakgroup weak_vsm_cmd_register_event_t */

/** @addtogroup vsm_evt_vocoder_op_mode_update
@{ */
/** @ingroup vsm_evt_vocoder_op_mode_update
    Indicates a change in the vocoder operating mode.

  @apr_hdr_fields
    Opcode -- VSM_EVT_VOC_OPERATING_MODE_UPDATE
    @par
    Src_port -- Handle to the session raising the event

  @apr_msgpayload{vsm_evt_voc_operating_mode_update_t}
    @table{weak__vsm__evt__voc__operating__mode__update__t}

  @return
    None.

  @dependencies
    An event is raised only if that event is registered through
    #VSM_CMD_REGISTER_EVENT.
*/
#define VSM_EVT_VOC_OPERATING_MODE_UPDATE ( 0x00011068 )

/** Valid operating mode directions.
*/
typedef enum vsm_voc_operating_mode_direction_t
{
   VSM_VOC_OPERATING_MODE_DIRECTION_TX = 0,
   /**< Mode change detection on the Tx path (encoder). */

   VSM_VOC_OPERATING_MODE_DIRECTION_RX 
   /**< Mode change detection on the Rx path (decoder). */

}/** @cond */ vsm_voc_operating_mode_direction_t /** @endcond */;

/** No valid vocoder bandwidth mode is set. */
#define VSM_VOC_OPERATING_MODE_NONE   ( 0x00013085 )

/** @cond OEM_only */
/** Vocoder bandwidth mode is 8 kHz (narrowband). */
#define VSM_VOC_OPERATING_MODE_NB     ( 0x00013086 )

/** Vocoder bandwidth mode is 16 kHz (wideband). */
#define VSM_VOC_OPERATING_MODE_WB     ( 0x00013087 )

/** Vocoder bandwidth mode is 32 kHz (super wideband). */
#define VSM_VOC_OPERATING_MODE_SWB    ( 0x00013088 )

/** Vocoder bandwidth mode is 48 kHz (full band). */
#define VSM_VOC_OPERATING_MODE_FB     ( 0x00013089 )
/** @endcond */

/** @} */ /* end_addtogroup vsm_evt_vocoder_op_mode_update */
...
/** @weakgroup weak_vsm_evt_voc_operating_mode_update_t
@{ */
struct vsm_evt_voc_operating_mode_update_t
{
    uint16_t direction;
    /**< Indicates the direction (Tx or Rx) where the mode change is detected.

         @values See #vsm_voc_operating_mode_direction_t */

    uint16_t reserved;
    /**< Clients must set this field to zero. */

    uint32_t mode;
    /**< Indicates the new vocoder bandwidth mode.

    @if OEM_only
         @values
         - #VSM_VOC_OPERATING_MODE_NONE
         - #VSM_VOC_OPERATING_MODE_NB
         - #VSM_VOC_OPERATING_MODE_WB
         - #VSM_VOC_OPERATING_MODE_SWB
         - #VSM_VOC_OPERATING_MODE_FB @tablebulletend
    @endif
    @if ISV_only
         @values #VSM_VOC_OPERATING_MODE_NONE
    @endif */

}
#include "adsp_end_pack.h"
;
/** @} */ /* end_weakgroup weak_vsm_evt_voc_operating_mode_update_t */
