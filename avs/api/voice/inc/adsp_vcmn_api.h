...
/** @ingroup voice_common_cmd_config_param
  ...
  @apr_msgpayload{voice_set_param_v2_t}
...
struct voice_set_param_v2_t
{
   ...
   /**< Unique identifier for an address. This handle is returned by the aDSP
        ...
        - Non-NULL -- Parameter data payloads begin at the address specified
          ...
          (out-of-band) (see <b>Parameter data variable payload</b>).
...
/** @ingroup voice_common_cmd_get_param
  ...
  @apr_msgpayload{voice_get_param_v2_t}
...
/** If parameter data is in-band, sufficient memory to hold the parameter data
    plus the %voice_param_data_t header must be present in the <b>Parameter
    data variable payload</b> following the mem_map_handle field.
*/
...
/** @ingroup voice_common_evt_get_param_ack
  ...
  @apr_msgpayload{voice_get_param_ack_t}
  ...
  @description
    ...
    because of the transport layer size limitation. @newpage
...
/** In an in-band scenario, immediately following this structure is the
	<b>Parameter data variable payload</b>, whose size depends on the size of the
...
/** Sets the VFR mode and timing offsets in a session.
  ...
  @apr_msgpayload{voice_set_timing_params_t}
...
/** Starts a host PCM session on a set of tap points for a specified device or
  ...
  @apr_msgpayload{voice_start_host_pcm_v2_t}
...
struct voice_start_host_pcm_v2_t
{
  ...
  /**< Dummy array of tap points (<b>Tap point payload</b>).
...
/** @ingroup voice_common_evt_push_host_buffers
  ...
  @apr_msgpayload{voice_evt_push_host_pcm_buf_v2_t}
...
/** @cond OEM_only */
/** @addtogroup voice_common_evt_host_buffers_avail
@{ */
/** Indicates that the firmware has finished processing a buffer previously
  ...
  @apr_msgpayload{voice_evt_notify_host_pcm_buf_v2_t}
...
/** @} */ /* end_addtogroup voice_common_evt_host_buffers_avail */
...
/** Allows a client to set Mute/Unmute mode on a specified paired stream/device
  ...
  @apr_msgpayload{voice_set_soft_mute_v2_t}
  ...
  @dependencies
    A valid device/stream session must have been created. @newpage
*/
...
/** Maps multiple shared memory regions. All regions must come from the same
  ...
  @apr_msgpayload{voice_cmd_shared_mem_map_regions_t}
...
struct voice_cmd_shared_mem_map_regions_t
{
    ...
    /**< Type of memory on which this memory region is mapped.
         ...
         VOICE_MAP_MEMORY_SHMEM8_4K_POOL is shared memory, 8 byte addressable,
         and 4 KB aligned. */
...
/** @ingroup voice_common_resp_mem_map
  ...
  @apr_msgpayload{voice_rsp_shared_mem_map_regions_t}
...
/** @ingroup voice_common_cmd_map_unmem_region
  ...
  @apr_msgpayload{voice_cmd_shared_mem_unmap_regions_t}
...
/** @ingroup voice_common_cmd_config_param_3
    Sends calibration data using the compressed data format representation in
    the ACDB.

  @apr_hdr_fields
    Opcode -- VOICE_CMD_SET_PARAM_V3
    @par
    Dst_port -- Handle to the session

  @apr_msgpayload{voice_cmd_set_param_v3_t}
    @table{weak__voice__cmd__set__param__v3__t}
...
/** @weakgroup weak_voice_cmd_set_param_v3_t
@{ */
struct voice_cmd_set_param_v3_t
{
    uint32_t cal_handle;
    /**< Handle used to query the CVD calibration utility for calibration
         entries. */
}
#include "adsp_end_pack.h"
;
/** @} */ /* end_weakgroup weak_voice_cmd_set_param_v3_t */
