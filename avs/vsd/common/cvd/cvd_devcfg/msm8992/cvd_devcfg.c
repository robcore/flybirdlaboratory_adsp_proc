/*
  ...
  $Header: //components/rel/avs.adsp/2.6.1/vsd/common/cvd/cvd_devcfg/msm8992/cvd_devcfg.c#5 $
  $Author: pwbldsvc $
*/
...
/**
  ...
  1. Voice use case <-> clock value table as follows: 
     ...
     -----------------------------------------------------------------------------------
     ANY +            |  128MHz/HW thread |  175MHz/HW thread   |  175MHz/HW thread    |
     SOFT VFR         |                   |                     |                      |                      
     -----------------------------------------------------------------------------------
     NONE +           |  128MHz/HW thread |  175MHz/HW thread   |  175MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     SM_ECNS +        |  128MHz/HW thread |  175MHz/HW thread   |  175MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     DM_FLUENCE +     |  128MHz/HW thread |  175MHz/HW thread   |  175MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
     SM_FLUENCEV5 +   |  128MHz/HW thread |  175MHz/HW thread   |  175MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
     DM_VPECNS +      |  128MHz/HW thread |  175MHz/HW thread   |  175MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
     DM_FLUENCEV5 +   |  128MHz/HW thread |  175MHz/HW thread   |  175MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     TM_FLUENCE +     |  128MHz/HW thread |  175MHz/HW thread   |  175MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     QM_FLUENCE_PRO + |  175MHz/HW thread |  175MHz/HW thread   |  175MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
...
static cvd_devcfg_clock_level_t cvd_devcfg_clock_levels[ 3 ] = 
  {
    { 128000000, 9, cvd_devcfg_clock_level_0_use_cases },
    { 175000000, 3, cvd_devcfg_clock_level_1_use_cases },
    { 175000000, 1, cvd_devcfg_clock_level_2_use_cases } 
  };
