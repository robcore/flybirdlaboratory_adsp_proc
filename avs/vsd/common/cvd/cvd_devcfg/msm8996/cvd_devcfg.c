/*
  ...
  $Header: //components/rel/avs.adsp/2.6.1/vsd/common/cvd/cvd_devcfg/msm8996/cvd_devcfg.c#3 $
  $Author: svutukur $
*/
...
/**
  ...
  1. Voice use case <-> clock value table as follows: 
     ...
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     TM_FLUENCE +     |  83MHz/HW thread  |  147MHz/HW thread   |  147MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
...
static cvd_devcfg_clock_level_t cvd_devcfg_clock_levels[ 3 ] = 
  {
    { 83000000, 7, cvd_devcfg_clock_level_0_use_cases },
