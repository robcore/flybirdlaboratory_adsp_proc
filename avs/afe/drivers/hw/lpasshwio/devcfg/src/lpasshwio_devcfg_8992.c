/*==============================================================================
$Header: //components/rel/avs.adsp/2.6.1/afe/drivers/hw/lpasshwio/devcfg/src/lpasshwio_devcfg_8992.c#3 $
...
HwdAudioIfPropertyType audioif_prop = {0xFE0C0000, (128*1024), 0xFD9A0000, 
