/*==============================================================================
$Header: //components/rel/avs.adsp/2.6.1/afe/drivers/hw/lpasshwio/devcfg/src/lpasshwio_devcfg_8974.c#3 $
$DateTime: 2014/12/26 03:33:20 $
$Author: svutukur $
$Change: 7198050 $
$Revision: #3 $

FILE: lpasshwio_devcfg_8974.c 

DESCRIPTION: 8974 Device Config
...
lpasshwio_vfr_prop_t vfr_prop = {0xFE033000, 0x1000, 0x10000000, 0x0, 0x7, 0x1, 0, {36, 40, 0, 0}, {{0x0, 0x1}, {0x7, 0x0}, {0, 0x0}, {0, 0x0}}};
