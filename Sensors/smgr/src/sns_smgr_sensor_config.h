...
/* $Header: //components/rel/ssc.adsp/2.6.1/smgr/src/sns_smgr_sensor_config.h#1 $ */
...
#define SNS_SMGR_DD_SELF_SCHED                          0x80
 ...
 #define SNS_SMGR_SENSOR_0_BUS_ADDRESS               0x3C
 ...
 #define SNS_SMGR_SENSOR_0_OFF_TO_IDLE               10000 /* usec */ // RK check this with data sheet
 #define SNS_SMGR_SENSOR_0_IDLE_TO_READY             30000 /* usec */
 ...
 #define SNS_SMGR_SENSOR_0_GPIO_FIRST                64
 #define SNS_SMGR_SENSOR_0_GPIO_SECOND               0xffff
 #define SNS_SMGR_SENSOR_0_BUS_INSTANCE              5
#else
 #define SNS_SMGR_SENSOR_0_ENUM_CODE                 SNS_SMGR_ID_ACCEL_V01
 #define SNS_SMGR_SENSOR_0_DD_FN_LIST_PTR            &sns_accel_bma2x2_driver_fn_list
 #define SNS_SMGR_SENSOR_0_DEVICE_ID                 0
 ...
 #define SNS_SMGR_SENSOR_0_SENSITIVITY_DEFAULT       1 /* 16g fixed. */
 #define SNS_SMGR_SENSOR_0_FLAGS                     SNS_SMGR_NO_SENSITIVITY //RK check this with SMGR requirements
 #define SNS_SMGR_SENSOR_0_OFF_TO_IDLE               10000 /* usec */
 #define SNS_SMGR_SENSOR_0_IDLE_TO_READY             30000 /* usec */
 #define SNS_SMGR_SENSOR_0_REG_ITEM_TYPE             SNS_SMGR_REG_ITEM_TYPE_NONE
 #define SNS_SMGR_SENSOR_0_REG_ITEM_ID               SNS_REG_DRIVER_GROUP_ACCEL_V02
 #define SNS_SMGR_SENSOR_0_CAL_PRI_TYPE              SNS_SMGR_REG_ITEM_TYPE_NONE
 ...
 #define SNS_SMGR_SENSOR_1_DD_FN_LIST_PTR            &sns_bmg160_driver_fn_list
 #define SNS_SMGR_SENSOR_1_DEVICE_ID                 0
 #define SNS_SMGR_SENSOR_1_BUS_ADDRESS               0x68
 ...
 #define SNS_SMGR_SENSOR_1_BUS_INSTANCE              5
 ...
 #define SNS_SMGR_SENSOR_2_BUS_INSTANCE              5
#else
 #define SNS_SMGR_SENSOR_2_ENUM_CODE                 SNS_SMGR_ID_MAG_V01
 #define SNS_SMGR_SENSOR_2_DD_FN_LIST_PTR            &sns_dd_mag_hscdtd_if 
 #define SNS_SMGR_SENSOR_2_DEVICE_ID                 0
 #define SNS_SMGR_SENSOR_2_BUS_ADDRESS               0x0C
 #define SNS_SMGR_SENSOR_2_DATA_TYPE_1               SNS_DDF_SENSOR_MAG
 #define SNS_SMGR_SENSOR_2_DATA_TYPE_2               SNS_DDF_SENSOR__NONE
 ...
 #define SNS_SMGR_SENSOR_3_DD_FN_LIST_PTR            &sns_dd_press_lps25h_if
 #define SNS_SMGR_SENSOR_3_DEVICE_ID                 0
 #define SNS_SMGR_SENSOR_3_BUS_ADDRESS               0x5C
 ...
 #define SNS_SMGR_SENSOR_3_BUS_INSTANCE              7
 ...
 #define SNS_SMGR_SENSOR_4_BUS_INSTANCE              7
#else
 #define SNS_SMGR_SENSOR_4_ENUM_CODE                 SNS_SMGR_ID_PROX_LIGHT_V01
 #define SNS_SMGR_SENSOR_4_DD_FN_LIST_PTR            &sns_ams_tmg399x_alsprx_driver_fn_list
 #define SNS_SMGR_SENSOR_4_DEVICE_ID                 0
 ...
 #define SNS_SMGR_SENSOR_5_BUS_ADDRESS               0x70 //Virtio: 0x38
 ...
 #define SNS_SMGR_SENSOR_6_DD_FN_LIST_PTR            &sns_ams_tmg399x_alsprx_driver_fn_list 
 ...
 #define SNS_SMGR_SENSOR_6_BUS_INSTANCE              7
