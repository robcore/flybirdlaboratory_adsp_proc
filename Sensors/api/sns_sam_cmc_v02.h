...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.adsp/2.6.1/api/sns_sam_cmc_v02.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.13 
   It was generated on: Tue Aug 26 2014 (Spin 0)
...
#define SNS_SAM_CMC_SVC_V02_IDL_MINOR_VERS 0x01
...
#define SNS_SAM_CMC_MAX_ITEMS_IN_BATCH_V02 100
