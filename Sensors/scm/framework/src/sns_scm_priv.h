...
/* $Header: //components/rel/ssc.adsp/2.6.1/scm/framework/src/sns_scm_priv.h#3 $ */
...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2015-02-02  dk   Added sns_scm_motion_state_s
  2014-11-14  pn   Added num_clients to sns_scm_sensor_s
  2014-04-23  pn   Added handling for internal Sensor API
