...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/ssc.adsp/2.6.1/common/idl/src/sns_sam_rmd_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.10 
   It was generated on: Tue Jul 22 2014 (Spin 0)
...
static const qmi_idl_service_message_table_entry SNS_SAM_RMD_SVC_service_response_messages_v01[] = {
  ...
  {SNS_SAM_RMD_GET_ATTRIBUTES_RESP_V01, QMI_IDL_TYPE16(1, 1), 79}
};
