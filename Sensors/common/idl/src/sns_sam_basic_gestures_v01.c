...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/ssc.adsp/2.6.1/common/idl/src/sns_sam_basic_gestures_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const qmi_idl_service_message_table_entry SNS_SAM_BASIC_GESTURES_SVC_service_response_messages_v01[] = {
  ...
  {SNS_SAM_BASIC_GESTURES_GET_ATTRIBUTES_RESP_V01, QMI_IDL_TYPE16(1, 1), 79}
};
