...
------------------------------------------------------------------------------
  ...
  $Header: //components/rel/ssc.adsp/2.6.1/common/inc/sns_common.h#1 $
...
#define SNS_SMGR_QUE_MUTEX        (SNS_DSPS_MUTEX_PRI_BASE  + 3)
#define SNS_SAM_QUE_MUTEX         (SNS_DSPS_MUTEX_PRI_BASE  + 4)
#define SNS_PM_QUE_MUTEX          (SNS_DSPS_MUTEX_PRI_BASE  + 5)
#define SNS_SSM_QUE_MUTEX         (SNS_DSPS_MUTEX_PRI_BASE  + 6)
...
#define SNS_MODULE_PRI_DSPS_SMGR  (SNS_DSPS_MODULE_PRI_BASE + 2)
#define SNS_MODULE_PRI_DSPS_RH    (SNS_DSPS_MODULE_PRI_BASE + 3)
#define SNS_MODULE_PRI_DSPS_SAM   (SNS_DSPS_MODULE_PRI_BASE + 4)
#define SNS_MODULE_PRI_DSPS_SCM   (SNS_DSPS_MODULE_PRI_BASE + 5)
#ifdef SNS_QMI_ENABLE
#define SNS_MODULE_PRI_DSPS_DEBUG (SNS_DSPS_MODULE_PRI_BASE + 6)
...
#define SNS_MODULE_PRI_DSPS_SSM   (SNS_DSPS_MODULE_PRI_BASE + 8)
#define SNS_MODULE_PRI_DSPS_EVMGR (SNS_DSPS_MODULE_PRI_BASE + 7)
#define SNS_MODULE_PRI_DSPS_SAM   (SNS_DSPS_MODULE_PRI_BASE + 6)
#define SNS_MODULE_PRI_DSPS_RH    (SNS_DSPS_MODULE_PRI_BASE + 5)
#define SNS_MODULE_PRI_DSPS_SMGR  (SNS_DSPS_MODULE_PRI_BASE + 4)
#define SNS_MODULE_PRI_DSPS_SCM   (SNS_DSPS_MODULE_PRI_BASE + 3)
...
#define SNS_MODULE_PRI_DSPS_SMGR  (SNS_DSPS_MODULE_PRI_BASE + 7)
#define SNS_MODULE_PRI_DSPS_RH    (SNS_DSPS_MODULE_PRI_BASE + 6)
#define SNS_MODULE_PRI_DSPS_SAM   (SNS_DSPS_MODULE_PRI_BASE + 5)
...
#define SNS_MODULE_STK_SIZE_DSPS_SMGR   (0x400)
#define SNS_MODULE_STK_SIZE_DSPS_RH     (0x300)
...
sns_rtb_s sns_rtb[] = {
    ...
    { SNS_SYNC_PROXY_SVC_ID_V01,          SNS_MODULE_UNDEFINED,  SNS_GET_SVC_OBJ(SYNC_PROXY, 01),    NULL },          /* 50 */
};
