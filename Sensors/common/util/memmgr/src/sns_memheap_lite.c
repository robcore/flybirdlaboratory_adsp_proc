...
DESCRIPTION
 ...
 Copyright (c) 1997-2014 Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/ssc.adsp/2.6.1/common/util/memmgr/src/sns_memheap_lite.c#1 $ $DateTime: 2014/12/01 08:57:58 $ $Author: pwbldsvc $
